...
var G__15112 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__15112,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__15112;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq15114){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15115,G__15116,seq15114__$2);
});
...
var map__15121 = m;
var map__15121__$1 = (((((!((map__15121 == null))))?(((((map__15121.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15121.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15121):map__15121);
var file = cljs.core.get.call(null,map__15121__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15121__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15121__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__15121,map__15121__$1,file,line,column){
return (function (p1__15120_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__15120_SHARP_));
});})(map__15121,map__15121__$1,file,line,column))
...
var temp__5735__auto___15123 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___15123)){
var message_15124 = temp__5735__auto___15123;
cljs.core.println.call(null,message_15124);
} else {
}
...
var temp__5735__auto___15125 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___15125)){
var message_15126 = temp__5735__auto___15125;
cljs.core.println.call(null,message_15126);
} else {
}
...
var output_dir__$1 = (function (){var G__15127 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__15127,"/"].join('');
} else {
return G__15127;
}
})();
...
var G__15129 = exception.stack;
var G__15129__$1 = (((G__15129 == null))?null:clojure.string.split_lines.call(null,G__15129));
var G__15129__$2 = (((G__15129__$1 == null))?null:cljs.core.get.call(null,G__15129__$1,depth));
if((G__15129__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__15129__$2);
}
} else {
...
var vec__15130 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__15130,(0),null);
var column = cljs.core.nth.call(null,vec__15130,(1),null);
var vec__15133 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__15133,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__15133,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__15133,(2),null);
...
var m__$1 = (function (){var G__15136 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__15140 = (function (){var G__15139 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__15139);
} else {
return G__15139;
}
})();
...
return cljs.core.vary_meta.call(null,G__15141,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__15145 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__15145,(0),null);
var types = vec__15145;
...
return cljs.core.map.call(null,(function (p__15148){
var vec__15149 = p__15148;
var ns = cljs.core.nth.call(null,vec__15149,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__15149,(1),null);
return ((function (vec__15149,ns,vars__$1){
return (function (){
...
var G__15152 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__15152,G__15152__$1,env,once_fixtures,each_fixtures,vec__15149,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__15152,G__15152__$1,env,once_fixtures,each_fixtures,vec__15149,ns,vars__$1){
return (function (){
var seq__15153 = cljs.core.seq.call(null,vars__$1);
var chunk__15154 = null;
var count__15155 = (0);
var i__15156 = (0);
while(true){
if((i__15156 < count__15155)){
var v = cljs.core._nth.call(null,chunk__15154,i__15156);
var temp__5735__auto___15158 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___15158)){
var t_15159 = temp__5735__auto___15158;
each_fixture_fn.call(null,((function (seq__15153,chunk__15154,count__15155,i__15156,t_15159,temp__5735__auto___15158,v,each_fixture_fn,G__15152,G__15152__$1,env,once_fixtures,each_fixtures,vec__15149,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15159)));
});})(seq__15153,chunk__15154,count__15155,i__15156,t_15159,temp__5735__auto___15158,v,each_fixture_fn,G__15152,G__15152__$1,env,once_fixtures,each_fixtures,vec__15149,ns,vars__$1))
);
} else {
}


var G__15160 = seq__15153;
var G__15161 = chunk__15154;
var G__15162 = count__15155;
var G__15163 = (i__15156 + (1));
seq__15153 = G__15160;
chunk__15154 = G__15161;
count__15155 = G__15162;
i__15156 = G__15163;
continue;
} else {
...
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__15153__$1);
var G__15164 = cljs.core.chunk_rest.call(null,seq__15153__$1);
var G__15165 = c__4550__auto__;
var G__15166 = cljs.core.count.call(null,c__4550__auto__);
var G__15167 = (0);
seq__15153 = G__15164;
chunk__15154 = G__15165;
count__15155 = G__15166;
i__15156 = G__15167;
continue;
} else {
var v = cljs.core.first.call(null,seq__15153__$1);
var temp__5735__auto___15168__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___15168__$1)){
var t_15169 = temp__5735__auto___15168__$1;
each_fixture_fn.call(null,((function (seq__15153,chunk__15154,count__15155,i__15156,t_15169,temp__5735__auto___15168__$1,v,seq__15153__$1,temp__5735__auto__,each_fixture_fn,G__15152,G__15152__$1,env,once_fixtures,each_fixtures,vec__15149,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15169)));
});})(seq__15153,chunk__15154,count__15155,i__15156,t_15169,temp__5735__auto___15168__$1,v,seq__15153__$1,temp__5735__auto__,each_fixture_fn,G__15152,G__15152__$1,env,once_fixtures,each_fixtures,vec__15149,ns,vars__$1))
);
} else {
}


var G__15170 = cljs.core.next.call(null,seq__15153__$1);
var G__15171 = null;
var G__15172 = (0);
var G__15173 = (0);
seq__15153 = G__15170;
chunk__15154 = G__15171;
count__15155 = G__15172;
i__15156 = G__15173;
continue;
}
} else {
...
});})(each_fixture_fn,G__15152,G__15152__$1,env,once_fixtures,each_fixtures,vec__15149,ns,vars__$1))
);
});})(each_fixture_fn,G__15152,G__15152__$1,env,once_fixtures,each_fixtures,vec__15149,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15152__$1)].join('')));

}
})());
});
;})(vec__15149,ns,vars__$1))
