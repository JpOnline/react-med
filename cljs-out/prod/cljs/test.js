...
var G__15128 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__15128,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__15128;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq15130){
var G__15131 = cljs.core.first.call(null,seq15130);
var seq15130__$1 = cljs.core.next.call(null,seq15130);
var G__15132 = cljs.core.first.call(null,seq15130__$1);
var seq15130__$2 = cljs.core.next.call(null,seq15130__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15131,G__15132,seq15130__$2);
});
...
var file = cljs.core.get.call(null,map__15137__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15137__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15137__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__15137,map__15137__$1,file,line,column){
return (function (p1__15136_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__15136_SHARP_));
});})(map__15137,map__15137__$1,file,line,column))
...
var temp__5735__auto___15139 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___15139)){
var message_15140 = temp__5735__auto___15139;
cljs.core.println.call(null,message_15140);
} else {
}
...
var temp__5735__auto___15141 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___15141)){
var message_15142 = temp__5735__auto___15141;
cljs.core.println.call(null,message_15142);
} else {
}
...
var output_dir__$1 = (function (){var G__15143 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__15143,"/"].join('');
} else {
return G__15143;
}
})();
...
var G__15145 = exception.stack;
var G__15145__$1 = (((G__15145 == null))?null:clojure.string.split_lines.call(null,G__15145));
var G__15145__$2 = (((G__15145__$1 == null))?null:cljs.core.get.call(null,G__15145__$1,depth));
if((G__15145__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__15145__$2);
}
} else {
...
var vec__15146 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__15146,(0),null);
var column = cljs.core.nth.call(null,vec__15146,(1),null);
var vec__15149 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__15149,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__15149,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__15149,(2),null);
...
var m__$1 = (function (){var G__15152 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__15156 = (function (){var G__15155 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__15155);
} else {
return G__15155;
}
})();
...
return cljs.core.vary_meta.call(null,G__15157,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__15161 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__15161,(0),null);
var types = vec__15161;
...
return cljs.core.map.call(null,(function (p__15164){
var vec__15165 = p__15164;
var ns = cljs.core.nth.call(null,vec__15165,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__15165,(1),null);
return ((function (vec__15165,ns,vars__$1){
return (function (){
...
var G__15168 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__15168,G__15168__$1,env,once_fixtures,each_fixtures,vec__15165,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__15168,G__15168__$1,env,once_fixtures,each_fixtures,vec__15165,ns,vars__$1){
return (function (){
var seq__15169 = cljs.core.seq.call(null,vars__$1);
var chunk__15170 = null;
var count__15171 = (0);
var i__15172 = (0);
while(true){
if((i__15172 < count__15171)){
var v = cljs.core._nth.call(null,chunk__15170,i__15172);
var temp__5735__auto___15174 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___15174)){
var t_15175 = temp__5735__auto___15174;
each_fixture_fn.call(null,((function (seq__15169,chunk__15170,count__15171,i__15172,t_15175,temp__5735__auto___15174,v,each_fixture_fn,G__15168,G__15168__$1,env,once_fixtures,each_fixtures,vec__15165,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15175)));
});})(seq__15169,chunk__15170,count__15171,i__15172,t_15175,temp__5735__auto___15174,v,each_fixture_fn,G__15168,G__15168__$1,env,once_fixtures,each_fixtures,vec__15165,ns,vars__$1))
);
} else {
}


var G__15176 = seq__15169;
var G__15177 = chunk__15170;
var G__15178 = count__15171;
var G__15179 = (i__15172 + (1));
seq__15169 = G__15176;
chunk__15170 = G__15177;
count__15171 = G__15178;
i__15172 = G__15179;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__15169);
if(temp__5735__auto__){
var seq__15169__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__15169__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__15169__$1);
var G__15180 = cljs.core.chunk_rest.call(null,seq__15169__$1);
var G__15181 = c__4550__auto__;
var G__15182 = cljs.core.count.call(null,c__4550__auto__);
var G__15183 = (0);
seq__15169 = G__15180;
chunk__15170 = G__15181;
count__15171 = G__15182;
i__15172 = G__15183;
continue;
} else {
var v = cljs.core.first.call(null,seq__15169__$1);
var temp__5735__auto___15184__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___15184__$1)){
var t_15185 = temp__5735__auto___15184__$1;
each_fixture_fn.call(null,((function (seq__15169,chunk__15170,count__15171,i__15172,t_15185,temp__5735__auto___15184__$1,v,seq__15169__$1,temp__5735__auto__,each_fixture_fn,G__15168,G__15168__$1,env,once_fixtures,each_fixtures,vec__15165,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15185)));
});})(seq__15169,chunk__15170,count__15171,i__15172,t_15185,temp__5735__auto___15184__$1,v,seq__15169__$1,temp__5735__auto__,each_fixture_fn,G__15168,G__15168__$1,env,once_fixtures,each_fixtures,vec__15165,ns,vars__$1))
);
} else {
}


var G__15186 = cljs.core.next.call(null,seq__15169__$1);
var G__15187 = null;
var G__15188 = (0);
var G__15189 = (0);
seq__15169 = G__15186;
chunk__15170 = G__15187;
count__15171 = G__15188;
i__15172 = G__15189;
continue;
}
} else {
...
});})(each_fixture_fn,G__15168,G__15168__$1,env,once_fixtures,each_fixtures,vec__15165,ns,vars__$1))
);
});})(each_fixture_fn,G__15168,G__15168__$1,env,once_fixtures,each_fixtures,vec__15165,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15168__$1)].join('')));

}
})());
});
;})(vec__15165,ns,vars__$1))
