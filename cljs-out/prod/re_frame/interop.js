...
return [(function (){var pred__14317 = cljs.core.instance_QMARK_;
var expr__14318 = reactive_val;
if(cljs.core.truth_((pred__14317.cljs$core$IFn$_invoke$arity$2 ? pred__14317.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__14318) : pred__14317.call(null,reagent.ratom.RAtom,expr__14318)))){
return "ra";
} else {
if(cljs.core.truth_((pred__14317.cljs$core$IFn$_invoke$arity$2 ? pred__14317.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__14318) : pred__14317.call(null,reagent.ratom.RCursor,expr__14318)))){
return "rc";
} else {
if(cljs.core.truth_((pred__14317.cljs$core$IFn$_invoke$arity$2 ? pred__14317.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__14318) : pred__14317.call(null,reagent.ratom.Reaction,expr__14318)))){
return "rx";
} else {
if(cljs.core.truth_((pred__14317.cljs$core$IFn$_invoke$arity$2 ? pred__14317.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__14318) : pred__14317.call(null,reagent.ratom.Track,expr__14318)))){
return "tr";
} else {
return "other";
}
