...
var o21048 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21048["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21049 = temp__5733__auto____$1;
return (o21049["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20158__auto__ = f;
return (o__20158__auto__["toString"]).call(o__20158__auto__);
} else {
return "";
}
}catch (e21050){var _ = e21050;
return "";
}});
...
try{var o__20158__auto___21052 = t;
(o__20158__auto___21052["cljs$lang$ctorPrWriter"]).call(o__20158__auto___21052,t,writer);
}catch (e21051){var __21053 = e21051;
}
...
var char_code = (function (){var o__20158__auto__ = (new String(char$));
return (o__20158__auto__["charCodeAt"]).call(o__20158__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20158__auto__ = String;
return (o__20158__auto__["fromCharCode"]).call(o__20158__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21054 = num_code;
switch (G__21054) {
case (1):
return (185);
...
var o__20158__auto__ = String;
return (o__20158__auto__["fromCharCode"]).call(o__20158__auto__,superscript_code);
});
/**
...
}catch (e21056){var _e__20165__auto__ = e21056;
return false;
}})())){
...
var vec__21057 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21057,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o21060 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21060["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21061 = temp__5733__auto____$1;
return (o21061["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21064){
var vec__21065 = p__21064;
var ns_detector = cljs.core.nth.call(null,vec__21065,(0),null);
...
var G__21071 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21072 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21071;
remaining_tokens = G__21072;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21062){
var G__21063 = cljs.core.first.call(null,seq21062);
var seq21062__$1 = cljs.core.next.call(null,seq21062);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21063,seq21062__$1);
});
...
var vec__21076 = cljs.core.split_with.call(null,(function (p1__21075_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21075_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21076,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21076,(1),null);
...
var vec__21082 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21082,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21082,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21085 = cljs.core.rest.call(null,remaining_tokens);
var G__21086 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21085;
name_tokens = G__21086;
continue;
} else {
...
var vec__21089 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21089,(0),null);
var arity = cljs.core.nth.call(null,vec__21089,(1),null);
var vec__21092 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21092,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21092,(1),null);
var vec__21095 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21095,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21095,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21095,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21095,(3),null);
...
var vec__21101 = result;
var munged_ns = cljs.core.nth.call(null,vec__21101,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21101,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21101,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21101,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21101,(4),null);
var arity = cljs.core.nth.call(null,vec__21101,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__21105 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__21105,(0),null);
var args = cljs.core.nth.call(null,vec__21105,(1),null);
var vec__21108 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21108,(0),null);
var name = cljs.core.nth.call(null,vec__21108,(1),null);
...
var G__21111 = (arity + (1));
var G__21112 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21113){
var vec__21114 = p__21113;
var arity = cljs.core.nth.call(null,vec__21114,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21114,(1),null);
...
return cljs.core.get.call(null,arities,p1__21117_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21118_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21121){
var vec__21122 = p__21121;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21122,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21119){
var G__21120 = cljs.core.first.call(null,seq21119);
var seq21119__$1 = cljs.core.next.call(null,seq21119);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21120,seq21119__$1);
});
...
var map__21130 = options;
var map__21130__$1 = (((((!((map__21130 == null))))?(((((map__21130.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21130.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21130):map__21130);
var include_ns_QMARK_ = cljs.core.get.call(null,map__21130__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21130__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21130__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21130__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21131 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21131,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21131,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21131,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21131,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21131,(4),null);
var arity = cljs.core.nth.call(null,vec__21131,(5),null);
...
var o__20158__auto__ = f;
return (o__20158__auto__["getBasis"]).call(o__20158__auto__);
});
/**
...
}catch (e21135){var _e__20165__auto__ = e21135;
...
var G__21136 = (obj[cljs.core.first.call(null,path)]);
var G__21137 = cljs.core.rest.call(null,path);
obj = G__21136;
path = G__21137;
continue;
} else {
...
return (function (accum,p__21138){
var vec__21139 = p__21138;
var bit = cljs.core.nth.call(null,vec__21139,(0),null);
var protocol = cljs.core.nth.call(null,vec__21139,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21142){
var vec__21143 = p__21142;
var ns = cljs.core.nth.call(null,vec__21143,(0),null);
var name = cljs.core.nth.call(null,vec__21143,(1),null);
var selector = cljs.core.nth.call(null,vec__21143,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__21148,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21148,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21148,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21146_SHARP_){
return (obj[cljs.core.first.call(null,p1__21146_SHARP_)]);
});})(name,sorted_matches,vec__21148,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
