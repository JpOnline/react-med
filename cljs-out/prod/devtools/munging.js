...
var o21004 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21004["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21005 = temp__5733__auto____$1;
return (o21005["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20114__auto__ = f;
return (o__20114__auto__["toString"]).call(o__20114__auto__);
} else {
return "";
}
}catch (e21006){var _ = e21006;
return "";
}});
...
try{var o__20114__auto___21008 = t;
(o__20114__auto___21008["cljs$lang$ctorPrWriter"]).call(o__20114__auto___21008,t,writer);
}catch (e21007){var __21009 = e21007;
}
...
var char_code = (function (){var o__20114__auto__ = (new String(char$));
return (o__20114__auto__["charCodeAt"]).call(o__20114__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20114__auto__ = String;
return (o__20114__auto__["fromCharCode"]).call(o__20114__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21010 = num_code;
switch (G__21010) {
case (1):
return (185);
...
var o__20114__auto__ = String;
return (o__20114__auto__["fromCharCode"]).call(o__20114__auto__,superscript_code);
});
/**
...
}catch (e21012){var _e__20121__auto__ = e21012;
return false;
}})())){
...
var vec__21013 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21013,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o21016 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21016["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21017 = temp__5733__auto____$1;
return (o21017["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21020){
var vec__21021 = p__21020;
var ns_detector = cljs.core.nth.call(null,vec__21021,(0),null);
...
var G__21027 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21028 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21027;
remaining_tokens = G__21028;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21018){
var G__21019 = cljs.core.first.call(null,seq21018);
var seq21018__$1 = cljs.core.next.call(null,seq21018);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21019,seq21018__$1);
});
...
var vec__21032 = cljs.core.split_with.call(null,(function (p1__21031_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21031_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21032,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21032,(1),null);
...
var vec__21038 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21038,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21038,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21041 = cljs.core.rest.call(null,remaining_tokens);
var G__21042 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21041;
name_tokens = G__21042;
continue;
} else {
...
var vec__21045 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21045,(0),null);
var arity = cljs.core.nth.call(null,vec__21045,(1),null);
var vec__21048 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21048,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21048,(1),null);
var vec__21051 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21051,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21051,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21051,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21051,(3),null);
...
var vec__21057 = result;
var munged_ns = cljs.core.nth.call(null,vec__21057,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21057,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21057,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21057,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21057,(4),null);
var arity = cljs.core.nth.call(null,vec__21057,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__21061 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__21061,(0),null);
var args = cljs.core.nth.call(null,vec__21061,(1),null);
var vec__21064 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21064,(0),null);
var name = cljs.core.nth.call(null,vec__21064,(1),null);
...
var G__21067 = (arity + (1));
var G__21068 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21069){
var vec__21070 = p__21069;
var arity = cljs.core.nth.call(null,vec__21070,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21070,(1),null);
...
return cljs.core.get.call(null,arities,p1__21073_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21074_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21077){
var vec__21078 = p__21077;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21078,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21075){
var G__21076 = cljs.core.first.call(null,seq21075);
var seq21075__$1 = cljs.core.next.call(null,seq21075);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21076,seq21075__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21086__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21086__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21086__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21086__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21087 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21087,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21087,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21087,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21087,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21087,(4),null);
var arity = cljs.core.nth.call(null,vec__21087,(5),null);
...
var o__20114__auto__ = f;
return (o__20114__auto__["getBasis"]).call(o__20114__auto__);
});
/**
...
}catch (e21091){var _e__20121__auto__ = e21091;
...
var G__21092 = (obj[cljs.core.first.call(null,path)]);
var G__21093 = cljs.core.rest.call(null,path);
obj = G__21092;
path = G__21093;
continue;
} else {
...
return (function (accum,p__21094){
var vec__21095 = p__21094;
var bit = cljs.core.nth.call(null,vec__21095,(0),null);
var protocol = cljs.core.nth.call(null,vec__21095,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21098){
var vec__21099 = p__21098;
var ns = cljs.core.nth.call(null,vec__21099,(0),null);
var name = cljs.core.nth.call(null,vec__21099,(1),null);
var selector = cljs.core.nth.call(null,vec__21099,(2),null);
...
return (function (p__21103){
var vec__21104 = p__21103;
var munged_name = cljs.core.nth.call(null,vec__21104,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21104,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21104,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21102_SHARP_){
return (obj[cljs.core.first.call(null,p1__21102_SHARP_)]);
});})(name,sorted_matches,vec__21104,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
