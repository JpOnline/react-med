...
var o15926 = temp__5733__auto__;
var temp__5733__auto____$1 = (o15926["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o15927 = temp__5733__auto____$1;
return (o15927["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15036__auto__ = f;
return (o__15036__auto__["toString"]).call(o__15036__auto__);
} else {
return "";
}
}catch (e15928){var _ = e15928;
return "";
}});
...
try{var o__15036__auto___15930 = t;
(o__15036__auto___15930["cljs$lang$ctorPrWriter"]).call(o__15036__auto___15930,t,writer);
}catch (e15929){var __15931 = e15929;
}
...
var char_code = (function (){var o__15036__auto__ = (new String(char$));
return (o__15036__auto__["charCodeAt"]).call(o__15036__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15036__auto__ = String;
return (o__15036__auto__["fromCharCode"]).call(o__15036__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15932 = num_code;
switch (G__15932) {
case (1):
return (185);
...
var o__15036__auto__ = String;
return (o__15036__auto__["fromCharCode"]).call(o__15036__auto__,superscript_code);
});
/**
...
}catch (e15934){var _e__15043__auto__ = e15934;
return false;
}})())){
...
var vec__15935 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15935,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o15938 = temp__5733__auto__;
var temp__5733__auto____$1 = (o15938["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o15939 = temp__5733__auto____$1;
return (o15939["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___15946 = arguments.length;
var i__4731__auto___15947 = (0);
while(true){
if((i__4731__auto___15947 < len__4730__auto___15946)){
args__4736__auto__.push((arguments[i__4731__auto___15947]));

var G__15948 = (i__4731__auto___15947 + (1));
i__4731__auto___15947 = G__15948;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15942){
var vec__15943 = p__15942;
var ns_detector = cljs.core.nth.call(null,vec__15943,(0),null);
...
var G__15949 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15950 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15949;
remaining_tokens = G__15950;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15940){
var G__15941 = cljs.core.first.call(null,seq15940);
var seq15940__$1 = cljs.core.next.call(null,seq15940);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15941,seq15940__$1);
});
...
var vec__15954 = cljs.core.split_with.call(null,(function (p1__15953_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15953_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15954,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15954,(1),null);
...
var vec__15960 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15960,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15960,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15963 = cljs.core.rest.call(null,remaining_tokens);
var G__15964 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15963;
name_tokens = G__15964;
continue;
} else {
...
var vec__15967 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15967,(0),null);
var arity = cljs.core.nth.call(null,vec__15967,(1),null);
var vec__15970 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15970,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15970,(1),null);
var vec__15973 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15973,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15973,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15973,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15973,(3),null);
...
var vec__15979 = result;
var munged_ns = cljs.core.nth.call(null,vec__15979,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15979,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15979,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15979,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15979,(4),null);
var arity = cljs.core.nth.call(null,vec__15979,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__15983 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__15983,(0),null);
var args = cljs.core.nth.call(null,vec__15983,(1),null);
var vec__15986 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15986,(0),null);
var name = cljs.core.nth.call(null,vec__15986,(1),null);
...
var G__15989 = (arity + (1));
var G__15990 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15991){
var vec__15992 = p__15991;
var arity = cljs.core.nth.call(null,vec__15992,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15992,(1),null);
...
return cljs.core.get.call(null,arities,p1__15995_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15996_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___16003 = arguments.length;
var i__4731__auto___16004 = (0);
while(true){
if((i__4731__auto___16004 < len__4730__auto___16003)){
args__4736__auto__.push((arguments[i__4731__auto___16004]));

var G__16005 = (i__4731__auto___16004 + (1));
i__4731__auto___16004 = G__16005;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15999){
var vec__16000 = p__15999;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16000,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15997){
var G__15998 = cljs.core.first.call(null,seq15997);
var seq15997__$1 = cljs.core.next.call(null,seq15997);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15998,seq15997__$1);
});
...
var G__16006 = arg;
var G__16006__$1 = (((G__16006 instanceof cljs.core.Keyword))?G__16006.fqn:null);
switch (G__16006__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__16008__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16008__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16008__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16008__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16009 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16009,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16009,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16009,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16009,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16009,(4),null);
var arity = cljs.core.nth.call(null,vec__16009,(5),null);
...
var o__15036__auto__ = f;
return (o__15036__auto__["getBasis"]).call(o__15036__auto__);
});
/**
...
}catch (e16013){var _e__15043__auto__ = e16013;
...
var G__16014 = (obj[cljs.core.first.call(null,path)]);
var G__16015 = cljs.core.rest.call(null,path);
obj = G__16014;
path = G__16015;
continue;
} else {
...
return (function (accum,p__16016){
var vec__16017 = p__16016;
var bit = cljs.core.nth.call(null,vec__16017,(0),null);
var protocol = cljs.core.nth.call(null,vec__16017,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16020){
var vec__16021 = p__16020;
var ns = cljs.core.nth.call(null,vec__16021,(0),null);
var name = cljs.core.nth.call(null,vec__16021,(1),null);
var selector = cljs.core.nth.call(null,vec__16021,(2),null);
...
return (function (p__16025){
var vec__16026 = p__16025;
var munged_name = cljs.core.nth.call(null,vec__16026,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16026,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__16026,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__16024_SHARP_){
return (obj[cljs.core.first.call(null,p1__16024_SHARP_)]);
});})(name,sorted_matches,vec__16026,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
