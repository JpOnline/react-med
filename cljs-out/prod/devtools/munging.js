...
var o20994 = temp__5733__auto__;
var temp__5733__auto____$1 = (o20994["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o20995 = temp__5733__auto____$1;
return (o20995["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20104__auto__ = f;
return (o__20104__auto__["toString"]).call(o__20104__auto__);
} else {
return "";
}
}catch (e20996){var _ = e20996;
return "";
}});
...
try{var o__20104__auto___20998 = t;
(o__20104__auto___20998["cljs$lang$ctorPrWriter"]).call(o__20104__auto___20998,t,writer);
}catch (e20997){var __20999 = e20997;
}
...
var char_code = (function (){var o__20104__auto__ = (new String(char$));
return (o__20104__auto__["charCodeAt"]).call(o__20104__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20104__auto__ = String;
return (o__20104__auto__["fromCharCode"]).call(o__20104__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21000 = num_code;
switch (G__21000) {
case (1):
return (185);
...
var o__20104__auto__ = String;
return (o__20104__auto__["fromCharCode"]).call(o__20104__auto__,superscript_code);
});
/**
...
}catch (e21002){var _e__20111__auto__ = e21002;
return false;
}})())){
...
var vec__21003 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21003,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o21006 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21006["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21007 = temp__5733__auto____$1;
return (o21007["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21010){
var vec__21011 = p__21010;
var ns_detector = cljs.core.nth.call(null,vec__21011,(0),null);
...
var G__21017 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21018 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21017;
remaining_tokens = G__21018;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21008){
var G__21009 = cljs.core.first.call(null,seq21008);
var seq21008__$1 = cljs.core.next.call(null,seq21008);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21009,seq21008__$1);
});
...
var vec__21022 = cljs.core.split_with.call(null,(function (p1__21021_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21021_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21022,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21022,(1),null);
...
var vec__21028 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21028,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21028,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21031 = cljs.core.rest.call(null,remaining_tokens);
var G__21032 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21031;
name_tokens = G__21032;
continue;
} else {
...
var vec__21035 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21035,(0),null);
var arity = cljs.core.nth.call(null,vec__21035,(1),null);
var vec__21038 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21038,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21038,(1),null);
var vec__21041 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21041,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21041,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21041,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21041,(3),null);
...
var vec__21047 = result;
var munged_ns = cljs.core.nth.call(null,vec__21047,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21047,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21047,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21047,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21047,(4),null);
var arity = cljs.core.nth.call(null,vec__21047,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__21051 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__21051,(0),null);
var args = cljs.core.nth.call(null,vec__21051,(1),null);
var vec__21054 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21054,(0),null);
var name = cljs.core.nth.call(null,vec__21054,(1),null);
...
var G__21057 = (arity + (1));
var G__21058 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21059){
var vec__21060 = p__21059;
var arity = cljs.core.nth.call(null,vec__21060,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21060,(1),null);
...
return cljs.core.get.call(null,arities,p1__21063_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21064_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___21071 = arguments.length;
var i__4731__auto___21072 = (0);
while(true){
if((i__4731__auto___21072 < len__4730__auto___21071)){
args__4736__auto__.push((arguments[i__4731__auto___21072]));

var G__21073 = (i__4731__auto___21072 + (1));
i__4731__auto___21072 = G__21073;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21067){
var vec__21068 = p__21067;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21068,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21065){
...
var G__21074 = arg;
var G__21074__$1 = (((G__21074 instanceof cljs.core.Keyword))?G__21074.fqn:null);
switch (G__21074__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21076__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21076__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21076__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21076__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21077 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21077,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21077,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21077,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21077,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21077,(4),null);
var arity = cljs.core.nth.call(null,vec__21077,(5),null);
...
var o__20104__auto__ = f;
return (o__20104__auto__["getBasis"]).call(o__20104__auto__);
});
/**
...
}catch (e21081){var _e__20111__auto__ = e21081;
...
var G__21082 = (obj[cljs.core.first.call(null,path)]);
var G__21083 = cljs.core.rest.call(null,path);
obj = G__21082;
path = G__21083;
continue;
} else {
...
return (function (accum,p__21084){
var vec__21085 = p__21084;
var bit = cljs.core.nth.call(null,vec__21085,(0),null);
var protocol = cljs.core.nth.call(null,vec__21085,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21088){
var vec__21089 = p__21088;
var ns = cljs.core.nth.call(null,vec__21089,(0),null);
var name = cljs.core.nth.call(null,vec__21089,(1),null);
var selector = cljs.core.nth.call(null,vec__21089,(2),null);
...
return (function (p__21093){
var vec__21094 = p__21093;
var munged_name = cljs.core.nth.call(null,vec__21094,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21094,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21094,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21092_SHARP_){
return (obj[cljs.core.first.call(null,p1__21092_SHARP_)]);
});})(name,sorted_matches,vec__21094,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
