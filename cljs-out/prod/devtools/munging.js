...
var o21684 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21684["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21685 = temp__5733__auto____$1;
return (o21685["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20794__auto__ = f;
return (o__20794__auto__["toString"]).call(o__20794__auto__);
} else {
return "";
}
}catch (e21686){var _ = e21686;
return "";
}});
...
try{var o__20794__auto___21688 = t;
(o__20794__auto___21688["cljs$lang$ctorPrWriter"]).call(o__20794__auto___21688,t,writer);
}catch (e21687){var __21689 = e21687;
}
...
var char_code = (function (){var o__20794__auto__ = (new String(char$));
return (o__20794__auto__["charCodeAt"]).call(o__20794__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20794__auto__ = String;
return (o__20794__auto__["fromCharCode"]).call(o__20794__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21690 = num_code;
switch (G__21690) {
case (1):
return (185);
...
var o__20794__auto__ = String;
return (o__20794__auto__["fromCharCode"]).call(o__20794__auto__,superscript_code);
});
/**
...
}catch (e21692){var _e__20801__auto__ = e21692;
return false;
}})())){
...
var vec__21693 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21693,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o21696 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21696["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21697 = temp__5733__auto____$1;
return (o21697["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___21704 = arguments.length;
var i__4731__auto___21705 = (0);
while(true){
if((i__4731__auto___21705 < len__4730__auto___21704)){
args__4736__auto__.push((arguments[i__4731__auto___21705]));

var G__21706 = (i__4731__auto___21705 + (1));
i__4731__auto___21705 = G__21706;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21700){
var vec__21701 = p__21700;
var ns_detector = cljs.core.nth.call(null,vec__21701,(0),null);
...
var G__21707 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21708 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21707;
remaining_tokens = G__21708;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21698){
var G__21699 = cljs.core.first.call(null,seq21698);
var seq21698__$1 = cljs.core.next.call(null,seq21698);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21699,seq21698__$1);
});
...
var vec__21712 = cljs.core.split_with.call(null,(function (p1__21711_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21711_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21712,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21712,(1),null);
...
var vec__21718 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21718,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21718,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21721 = cljs.core.rest.call(null,remaining_tokens);
var G__21722 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21721;
name_tokens = G__21722;
continue;
} else {
...
var vec__21725 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21725,(0),null);
var arity = cljs.core.nth.call(null,vec__21725,(1),null);
var vec__21728 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21728,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21728,(1),null);
var vec__21731 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21731,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21731,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21731,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21731,(3),null);
...
var vec__21737 = result;
var munged_ns = cljs.core.nth.call(null,vec__21737,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21737,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21737,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21737,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21737,(4),null);
var arity = cljs.core.nth.call(null,vec__21737,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__21741 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__21741,(0),null);
var args = cljs.core.nth.call(null,vec__21741,(1),null);
var vec__21744 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21744,(0),null);
var name = cljs.core.nth.call(null,vec__21744,(1),null);
...
var G__21747 = (arity + (1));
var G__21748 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21749){
var vec__21750 = p__21749;
var arity = cljs.core.nth.call(null,vec__21750,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21750,(1),null);
...
return cljs.core.get.call(null,arities,p1__21753_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21754_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21757){
var vec__21758 = p__21757;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21758,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21755){
var G__21756 = cljs.core.first.call(null,seq21755);
var seq21755__$1 = cljs.core.next.call(null,seq21755);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21756,seq21755__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21766__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21766__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21766__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21766__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21767 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21767,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21767,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21767,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21767,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21767,(4),null);
var arity = cljs.core.nth.call(null,vec__21767,(5),null);
...
var o__20794__auto__ = f;
return (o__20794__auto__["getBasis"]).call(o__20794__auto__);
});
/**
...
}catch (e21771){var _e__20801__auto__ = e21771;
...
var G__21772 = (obj[cljs.core.first.call(null,path)]);
var G__21773 = cljs.core.rest.call(null,path);
obj = G__21772;
path = G__21773;
continue;
} else {
...
return (function (accum,p__21774){
var vec__21775 = p__21774;
var bit = cljs.core.nth.call(null,vec__21775,(0),null);
var protocol = cljs.core.nth.call(null,vec__21775,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21778){
var vec__21779 = p__21778;
var ns = cljs.core.nth.call(null,vec__21779,(0),null);
var name = cljs.core.nth.call(null,vec__21779,(1),null);
var selector = cljs.core.nth.call(null,vec__21779,(2),null);
...
return (function (p__21783){
var vec__21784 = p__21783;
var munged_name = cljs.core.nth.call(null,vec__21784,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21784,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21784,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21782_SHARP_){
return (obj[cljs.core.first.call(null,p1__21782_SHARP_)]);
});})(name,sorted_matches,vec__21784,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
