...
var o21065 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21065["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21066 = temp__5733__auto____$1;
return (o21066["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20175__auto__ = f;
return (o__20175__auto__["toString"]).call(o__20175__auto__);
} else {
return "";
}
}catch (e21067){var _ = e21067;
return "";
}});
...
try{var o__20175__auto___21069 = t;
(o__20175__auto___21069["cljs$lang$ctorPrWriter"]).call(o__20175__auto___21069,t,writer);
}catch (e21068){var __21070 = e21068;
}
...
var char_code = (function (){var o__20175__auto__ = (new String(char$));
return (o__20175__auto__["charCodeAt"]).call(o__20175__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20175__auto__ = String;
return (o__20175__auto__["fromCharCode"]).call(o__20175__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21071 = num_code;
switch (G__21071) {
case (1):
return (185);
...
var o__20175__auto__ = String;
return (o__20175__auto__["fromCharCode"]).call(o__20175__auto__,superscript_code);
});
/**
...
}catch (e21073){var _e__20182__auto__ = e21073;
return false;
}})())){
...
var vec__21074 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21074,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o21077 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21077["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21078 = temp__5733__auto____$1;
return (o21078["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___21085 = arguments.length;
var i__4731__auto___21086 = (0);
while(true){
if((i__4731__auto___21086 < len__4730__auto___21085)){
args__4736__auto__.push((arguments[i__4731__auto___21086]));

var G__21087 = (i__4731__auto___21086 + (1));
i__4731__auto___21086 = G__21087;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21081){
var vec__21082 = p__21081;
var ns_detector = cljs.core.nth.call(null,vec__21082,(0),null);
...
var G__21088 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21089 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21088;
remaining_tokens = G__21089;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21079){
...
var vec__21093 = cljs.core.split_with.call(null,(function (p1__21092_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21092_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21093,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21093,(1),null);
...
var vec__21099 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21099,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21099,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21102 = cljs.core.rest.call(null,remaining_tokens);
var G__21103 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21102;
name_tokens = G__21103;
continue;
} else {
...
var vec__21106 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21106,(0),null);
var arity = cljs.core.nth.call(null,vec__21106,(1),null);
var vec__21109 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21109,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21109,(1),null);
var vec__21112 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21112,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21112,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21112,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21112,(3),null);
...
var vec__21118 = result;
var munged_ns = cljs.core.nth.call(null,vec__21118,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21118,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21118,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21118,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21118,(4),null);
var arity = cljs.core.nth.call(null,vec__21118,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__21122 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__21122,(0),null);
var args = cljs.core.nth.call(null,vec__21122,(1),null);
var vec__21125 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21125,(0),null);
var name = cljs.core.nth.call(null,vec__21125,(1),null);
...
var G__21128 = (arity + (1));
var G__21129 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21130){
var vec__21131 = p__21130;
var arity = cljs.core.nth.call(null,vec__21131,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21131,(1),null);
...
return cljs.core.get.call(null,arities,p1__21134_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21135_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___21142 = arguments.length;
var i__4731__auto___21143 = (0);
while(true){
if((i__4731__auto___21143 < len__4730__auto___21142)){
args__4736__auto__.push((arguments[i__4731__auto___21143]));

var G__21144 = (i__4731__auto___21143 + (1));
i__4731__auto___21143 = G__21144;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21138){
var vec__21139 = p__21138;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21139,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21136){
var G__21137 = cljs.core.first.call(null,seq21136);
var seq21136__$1 = cljs.core.next.call(null,seq21136);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21137,seq21136__$1);
});
...
var map__21147 = options;
var map__21147__$1 = (((((!((map__21147 == null))))?(((((map__21147.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21147.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21147):map__21147);
var include_ns_QMARK_ = cljs.core.get.call(null,map__21147__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21147__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21147__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21147__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21148 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21148,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21148,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21148,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21148,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21148,(4),null);
var arity = cljs.core.nth.call(null,vec__21148,(5),null);
...
var o__20175__auto__ = f;
return (o__20175__auto__["getBasis"]).call(o__20175__auto__);
});
/**
...
}catch (e21152){var _e__20182__auto__ = e21152;
...
var G__21153 = (obj[cljs.core.first.call(null,path)]);
var G__21154 = cljs.core.rest.call(null,path);
obj = G__21153;
path = G__21154;
continue;
} else {
...
return (function (accum,p__21155){
var vec__21156 = p__21155;
var bit = cljs.core.nth.call(null,vec__21156,(0),null);
var protocol = cljs.core.nth.call(null,vec__21156,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21159){
var vec__21160 = p__21159;
var ns = cljs.core.nth.call(null,vec__21160,(0),null);
var name = cljs.core.nth.call(null,vec__21160,(1),null);
var selector = cljs.core.nth.call(null,vec__21160,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__21165,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21165,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21165,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21163_SHARP_){
return (obj[cljs.core.first.call(null,p1__21163_SHARP_)]);
});})(name,sorted_matches,vec__21165,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
