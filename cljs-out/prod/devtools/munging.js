...
var o21014 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21014["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21015 = temp__5733__auto____$1;
return (o21015["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20124__auto__ = f;
return (o__20124__auto__["toString"]).call(o__20124__auto__);
} else {
return "";
}
}catch (e21016){var _ = e21016;
return "";
}});
...
try{var o__20124__auto___21018 = t;
(o__20124__auto___21018["cljs$lang$ctorPrWriter"]).call(o__20124__auto___21018,t,writer);
}catch (e21017){var __21019 = e21017;
}
...
var char_code = (function (){var o__20124__auto__ = (new String(char$));
return (o__20124__auto__["charCodeAt"]).call(o__20124__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20124__auto__ = String;
return (o__20124__auto__["fromCharCode"]).call(o__20124__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21020 = num_code;
switch (G__21020) {
case (1):
return (185);
...
var o__20124__auto__ = String;
return (o__20124__auto__["fromCharCode"]).call(o__20124__auto__,superscript_code);
});
/**
...
}catch (e21022){var _e__20131__auto__ = e21022;
return false;
}})())){
...
var vec__21023 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21023,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o21026 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21026["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21027 = temp__5733__auto____$1;
return (o21027["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21030){
var vec__21031 = p__21030;
var ns_detector = cljs.core.nth.call(null,vec__21031,(0),null);
...
var G__21037 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21038 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21037;
remaining_tokens = G__21038;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21028){
var G__21029 = cljs.core.first.call(null,seq21028);
var seq21028__$1 = cljs.core.next.call(null,seq21028);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21029,seq21028__$1);
});
...
var vec__21042 = cljs.core.split_with.call(null,(function (p1__21041_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21041_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21042,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21042,(1),null);
...
var vec__21048 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21048,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21048,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21051 = cljs.core.rest.call(null,remaining_tokens);
var G__21052 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21051;
name_tokens = G__21052;
continue;
} else {
...
var vec__21055 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21055,(0),null);
var arity = cljs.core.nth.call(null,vec__21055,(1),null);
var vec__21058 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21058,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21058,(1),null);
var vec__21061 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21061,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21061,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21061,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21061,(3),null);
...
var vec__21067 = result;
var munged_ns = cljs.core.nth.call(null,vec__21067,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21067,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21067,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21067,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21067,(4),null);
var arity = cljs.core.nth.call(null,vec__21067,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__21071 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__21071,(0),null);
var args = cljs.core.nth.call(null,vec__21071,(1),null);
var vec__21074 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21074,(0),null);
var name = cljs.core.nth.call(null,vec__21074,(1),null);
...
var G__21077 = (arity + (1));
var G__21078 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21079){
var vec__21080 = p__21079;
var arity = cljs.core.nth.call(null,vec__21080,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21080,(1),null);
...
return cljs.core.get.call(null,arities,p1__21083_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21084_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21087){
var vec__21088 = p__21087;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21088,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21085){
var G__21086 = cljs.core.first.call(null,seq21085);
var seq21085__$1 = cljs.core.next.call(null,seq21085);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21086,seq21085__$1);
});
...
var map__21096 = options;
var map__21096__$1 = (((((!((map__21096 == null))))?(((((map__21096.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21096.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21096):map__21096);
var include_ns_QMARK_ = cljs.core.get.call(null,map__21096__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21096__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21096__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21096__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21097 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21097,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21097,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21097,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21097,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21097,(4),null);
var arity = cljs.core.nth.call(null,vec__21097,(5),null);
...
var o__20124__auto__ = f;
return (o__20124__auto__["getBasis"]).call(o__20124__auto__);
});
/**
...
}catch (e21101){var _e__20131__auto__ = e21101;
...
var G__21102 = (obj[cljs.core.first.call(null,path)]);
var G__21103 = cljs.core.rest.call(null,path);
obj = G__21102;
path = G__21103;
continue;
} else {
...
return (function (accum,p__21104){
var vec__21105 = p__21104;
var bit = cljs.core.nth.call(null,vec__21105,(0),null);
var protocol = cljs.core.nth.call(null,vec__21105,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21108){
var vec__21109 = p__21108;
var ns = cljs.core.nth.call(null,vec__21109,(0),null);
var name = cljs.core.nth.call(null,vec__21109,(1),null);
var selector = cljs.core.nth.call(null,vec__21109,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__21114,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21114,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21114,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21112_SHARP_){
return (obj[cljs.core.first.call(null,p1__21112_SHARP_)]);
});})(name,sorted_matches,vec__21114,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
