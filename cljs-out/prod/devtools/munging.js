...
var o15927 = temp__5733__auto__;
var temp__5733__auto____$1 = (o15927["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o15928 = temp__5733__auto____$1;
return (o15928["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15037__auto__ = f;
return (o__15037__auto__["toString"]).call(o__15037__auto__);
} else {
return "";
}
...
try{var o__15037__auto___15931 = t;
(o__15037__auto___15931["cljs$lang$ctorPrWriter"]).call(o__15037__auto___15931,t,writer);
}catch (e15930){var __15932 = e15930;
}
...
var char_code = (function (){var o__15037__auto__ = (new String(char$));
return (o__15037__auto__["charCodeAt"]).call(o__15037__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15037__auto__ = String;
return (o__15037__auto__["fromCharCode"]).call(o__15037__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15933 = num_code;
switch (G__15933) {
case (1):
return (185);
...
var o__15037__auto__ = String;
return (o__15037__auto__["fromCharCode"]).call(o__15037__auto__,superscript_code);
});
/**
...
}catch (e15935){var _e__15044__auto__ = e15935;
return false;
}})())){
...
var vec__15936 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15936,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o15939 = temp__5733__auto__;
var temp__5733__auto____$1 = (o15939["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o15940 = temp__5733__auto____$1;
return (o15940["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___15947 = arguments.length;
var i__4731__auto___15948 = (0);
while(true){
if((i__4731__auto___15948 < len__4730__auto___15947)){
args__4736__auto__.push((arguments[i__4731__auto___15948]));

var G__15949 = (i__4731__auto___15948 + (1));
i__4731__auto___15948 = G__15949;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15943){
var vec__15944 = p__15943;
var ns_detector = cljs.core.nth.call(null,vec__15944,(0),null);
...
var G__15950 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15951 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15950;
remaining_tokens = G__15951;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15941){
var G__15942 = cljs.core.first.call(null,seq15941);
var seq15941__$1 = cljs.core.next.call(null,seq15941);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15942,seq15941__$1);
});
...
var vec__15955 = cljs.core.split_with.call(null,(function (p1__15954_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15954_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15955,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15955,(1),null);
...
var vec__15961 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15961,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15961,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15964 = cljs.core.rest.call(null,remaining_tokens);
var G__15965 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15964;
name_tokens = G__15965;
continue;
} else {
...
var vec__15968 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15968,(0),null);
var arity = cljs.core.nth.call(null,vec__15968,(1),null);
var vec__15971 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15971,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15971,(1),null);
var vec__15974 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15974,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15974,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15974,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15974,(3),null);
...
var vec__15980 = result;
var munged_ns = cljs.core.nth.call(null,vec__15980,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15980,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15980,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15980,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15980,(4),null);
var arity = cljs.core.nth.call(null,vec__15980,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__15984 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__15984,(0),null);
var args = cljs.core.nth.call(null,vec__15984,(1),null);
var vec__15987 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15987,(0),null);
var name = cljs.core.nth.call(null,vec__15987,(1),null);
...
var G__15990 = (arity + (1));
var G__15991 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15992){
var vec__15993 = p__15992;
var arity = cljs.core.nth.call(null,vec__15993,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15993,(1),null);
...
return cljs.core.get.call(null,arities,p1__15996_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15997_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___16004 = arguments.length;
var i__4731__auto___16005 = (0);
while(true){
if((i__4731__auto___16005 < len__4730__auto___16004)){
args__4736__auto__.push((arguments[i__4731__auto___16005]));

var G__16006 = (i__4731__auto___16005 + (1));
i__4731__auto___16005 = G__16006;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16000){
var vec__16001 = p__16000;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16001,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15998){
var G__15999 = cljs.core.first.call(null,seq15998);
var seq15998__$1 = cljs.core.next.call(null,seq15998);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15999,seq15998__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__16009__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16009__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16009__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16009__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16010 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16010,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16010,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16010,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16010,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16010,(4),null);
var arity = cljs.core.nth.call(null,vec__16010,(5),null);
...
var o__15037__auto__ = f;
return (o__15037__auto__["getBasis"]).call(o__15037__auto__);
});
/**
...
}catch (e16014){var _e__15044__auto__ = e16014;
...
var G__16015 = (obj[cljs.core.first.call(null,path)]);
var G__16016 = cljs.core.rest.call(null,path);
obj = G__16015;
path = G__16016;
continue;
} else {
...
return (function (accum,p__16017){
var vec__16018 = p__16017;
var bit = cljs.core.nth.call(null,vec__16018,(0),null);
var protocol = cljs.core.nth.call(null,vec__16018,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16021){
var vec__16022 = p__16021;
var ns = cljs.core.nth.call(null,vec__16022,(0),null);
var name = cljs.core.nth.call(null,vec__16022,(1),null);
var selector = cljs.core.nth.call(null,vec__16022,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__16027,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16027,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__16027,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__16025_SHARP_){
return (obj[cljs.core.first.call(null,p1__16025_SHARP_)]);
});})(name,sorted_matches,vec__16027,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
