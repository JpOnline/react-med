...
var G__21119 = devtools.prefs.pref.call(null,v);
v = G__21119;
continue;
} else {
return v;
...
}catch (e21122){var _e__20131__auto__ = e21122;
return false;
}})();
...
}catch (e21126){var _e__20131__auto__ = e21126;
return false;
}})();
...
}catch (e21128){var _e__20131__auto__ = e21128;
return false;
}}
}
});
...
var vec__21130 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21130,(0),null);
var name = cljs.core.nth.call(null,vec__21130,(1),null);
...
return cljs.core.some.call(null,(function (p1__21133_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21133_SHARP_);
}),template);
});
