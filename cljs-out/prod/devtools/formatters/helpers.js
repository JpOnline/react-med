...
var G__16032 = devtools.prefs.pref.call(null,v);
v = G__16032;
continue;
} else {
return v;
...
}catch (e16035){var _e__15044__auto__ = e16035;
return false;
}})();
...
}catch (e16039){var _e__15044__auto__ = e16039;
return false;
}})();
...
}catch (e16041){var _e__15044__auto__ = e16041;
return false;
}}
}
});
...
var vec__16043 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16043,(0),null);
var name = cljs.core.nth.call(null,vec__16043,(1),null);
...
return cljs.core.some.call(null,(function (p1__16046_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16046_SHARP_);
}),template);
});
