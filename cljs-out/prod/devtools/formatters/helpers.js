...
var G__21170 = devtools.prefs.pref.call(null,v);
v = G__21170;
continue;
} else {
return v;
...
}catch (e21173){var _e__20182__auto__ = e21173;
return false;
}})();
...
}catch (e21177){var _e__20182__auto__ = e21177;
return false;
}})();
...
}catch (e21179){var _e__20182__auto__ = e21179;
return false;
}}
}
});
...
var vec__21181 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21181,(0),null);
var name = cljs.core.nth.call(null,vec__21181,(1),null);
...
return cljs.core.some.call(null,(function (p1__21184_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21184_SHARP_);
}),template);
});
