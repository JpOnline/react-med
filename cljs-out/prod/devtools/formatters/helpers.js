...
var G__15903 = devtools.prefs.pref.call(null,v);
v = G__15903;
continue;
} else {
return v;
...
}catch (e15906){var _e__14915__auto__ = e15906;
return false;
}})();
...
}catch (e15910){var _e__14915__auto__ = e15910;
return false;
}})();
...
}catch (e15912){var _e__14915__auto__ = e15912;
return false;
}}
}
});
...
var vec__15914 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15914,(0),null);
var name = cljs.core.nth.call(null,vec__15914,(1),null);
...
return cljs.core.some.call(null,(function (p1__15917_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15917_SHARP_);
}),template);
});
