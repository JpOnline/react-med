...
var G__21789 = devtools.prefs.pref.call(null,v);
v = G__21789;
continue;
} else {
return v;
...
}catch (e21792){var _e__20801__auto__ = e21792;
return false;
}})();
...
}catch (e21796){var _e__20801__auto__ = e21796;
return false;
}})();
...
}catch (e21798){var _e__20801__auto__ = e21798;
return false;
}}
}
});
...
var vec__21800 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21800,(0),null);
var name = cljs.core.nth.call(null,vec__21800,(1),null);
...
return cljs.core.some.call(null,(function (p1__21803_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21803_SHARP_);
}),template);
});
