...
var G__21773 = devtools.prefs.pref.call(null,v);
v = G__21773;
continue;
} else {
return v;
...
}catch (e21776){var _e__20785__auto__ = e21776;
return false;
}})();
...
}catch (e21780){var _e__20785__auto__ = e21780;
return false;
}})();
...
}catch (e21782){var _e__20785__auto__ = e21782;
return false;
}}
}
});
...
var vec__21784 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21784,(0),null);
var name = cljs.core.nth.call(null,vec__21784,(1),null);
...
return cljs.core.some.call(null,(function (p1__21787_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21787_SHARP_);
}),template);
});
