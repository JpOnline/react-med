...
var G__21153 = devtools.prefs.pref.call(null,v);
v = G__21153;
continue;
} else {
return v;
...
}catch (e21156){var _e__20165__auto__ = e21156;
return false;
}})();
...
}catch (e21160){var _e__20165__auto__ = e21160;
return false;
}})();
...
}catch (e21162){var _e__20165__auto__ = e21162;
return false;
}}
}
});
...
var vec__21164 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21164,(0),null);
var name = cljs.core.nth.call(null,vec__21164,(1),null);
...
return cljs.core.some.call(null,(function (p1__21167_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21167_SHARP_);
}),template);
});
