...
var G__16031 = devtools.prefs.pref.call(null,v);
v = G__16031;
continue;
} else {
return v;
...
}catch (e16034){var _e__15043__auto__ = e16034;
return false;
}})();
...
}catch (e16038){var _e__15043__auto__ = e16038;
return false;
}})();
...
}catch (e16040){var _e__15043__auto__ = e16040;
return false;
}}
}
});
...
var vec__16042 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16042,(0),null);
var name = cljs.core.nth.call(null,vec__16042,(1),null);
...
return cljs.core.some.call(null,(function (p1__16045_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16045_SHARP_);
}),template);
});
