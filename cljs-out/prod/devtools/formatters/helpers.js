...
var G__21099 = devtools.prefs.pref.call(null,v);
v = G__21099;
continue;
} else {
return v;
...
}catch (e21102){var _e__20111__auto__ = e21102;
return false;
}})();
...
}catch (e21106){var _e__20111__auto__ = e21106;
return false;
}})();
...
}catch (e21108){var _e__20111__auto__ = e21108;
return false;
}}
}
});
...
var vec__21110 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21110,(0),null);
var name = cljs.core.nth.call(null,vec__21110,(1),null);
...
return cljs.core.some.call(null,(function (p1__21113_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21113_SHARP_);
}),template);
});
