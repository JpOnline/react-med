...
var G__21109 = devtools.prefs.pref.call(null,v);
v = G__21109;
continue;
} else {
return v;
...
}catch (e21112){var _e__20121__auto__ = e21112;
return false;
}})();
...
}catch (e21116){var _e__20121__auto__ = e21116;
return false;
}})();
...
}catch (e21118){var _e__20121__auto__ = e21118;
return false;
}}
}
});
...
var vec__21120 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21120,(0),null);
var name = cljs.core.nth.call(null,vec__21120,(1),null);
...
return cljs.core.some.call(null,(function (p1__21123_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21123_SHARP_);
}),template);
});
