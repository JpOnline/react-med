...
var o__14908__auto___16638 = (function (){var o__14908__auto__ = (function (){var o__14908__auto__ = Promise;
return (o__14908__auto__["resolve"]).call(o__14908__auto__);
})();
return (o__14908__auto__["then"]).call(o__14908__auto__,callback);
})();
(o__14908__auto___16638["catch"]).call(o__14908__auto___16638,devtools.async.rethrow_outside_promise);
...
var G__16639_16640 = Error;
var target__14913__auto___16641 = G__16639_16640;
if(cljs.core.truth_(target__14913__auto___16641)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16639_16640)].join(''),"\n","target__14913__auto__"].join('')));
}

(target__14913__auto___16641["stackTraceLimit"] = Infinity);
