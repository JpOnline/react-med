...
var o__15037__auto___16767 = (function (){var o__15037__auto__ = (function (){var o__15037__auto__ = Promise;
return (o__15037__auto__["resolve"]).call(o__15037__auto__);
})();
return (o__15037__auto__["then"]).call(o__15037__auto__,callback);
})();
(o__15037__auto___16767["catch"]).call(o__15037__auto___16767,devtools.async.rethrow_outside_promise);
...
var G__16768_16769 = Error;
var target__15042__auto___16770 = G__16768_16769;
if(cljs.core.truth_(target__15042__auto___16770)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16768_16769)].join(''),"\n","target__15042__auto__"].join('')));
}

(target__15042__auto___16770["stackTraceLimit"] = Infinity);
