...
return this3108.get(java_time_temporal_TemporalUnit3109);
});
cljc.java_time.temporal.temporal_amount.get_units = (function cljc$java_time$temporal$temporal_amount$get_units(this3110){
return this3110.units();
});
cljc.java_time.temporal.temporal_amount.add_to = (function cljc$java_time$temporal$temporal_amount$add_to(this3111,java_time_temporal_Temporal3112){
return this3111.addTo(java_time_temporal_Temporal3112);
});
