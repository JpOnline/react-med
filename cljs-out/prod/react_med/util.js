 ...
 *   hook can be used.
 */
react_med.util.with_mount_fn = (function react_med$util$with_mount_fn(p__15725){
var vec__15726 = p__15725;
var n = cljs.core.nth.call(null,vec__15726,(0),null);
var map__15729 = cljs.core.nth.call(null,vec__15726,(1),null);
...
var component_did_mount = cljs.core.get.call(null,map__15729__$1,new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518));
var to_render = vec__15726;
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (vec__15726,n,map__15729,map__15729__$1,component_did_mount,to_render){
return (function (){
...
return (function() {
var G__15732 = null;
var G__15732__1 = (function (app_state){
...
var G__15732__2 = (function (app_state,event){
...
G__15732 = function(app_state,event){
switch(arguments.length){
case 1:
return G__15732__1.call(this,app_state);
case 2:
return G__15732__2.call(this,app_state,event);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__15732.cljs$core$IFn$_invoke$arity$1 = G__15732__1;
G__15732.cljs$core$IFn$_invoke$arity$2 = G__15732__2;
return G__15732;
})()
});
...
var len__4730__auto___15739 = arguments.length;
var i__4731__auto___15740 = (0);
while(true){
if((i__4731__auto___15740 < len__4730__auto___15739)){
args__4736__auto__.push((arguments[i__4731__auto___15740]));

var G__15741 = (i__4731__auto___15740 + (1));
i__4731__auto___15740 = G__15741;
continue;
} else {
}
break;
...
react_med.util.round_to_precision.cljs$core$IFn$_invoke$arity$variadic = (function (n,p__15735){
var vec__15736 = p__15735;
var precision = cljs.core.nth.call(null,vec__15736,(0),null);
...
/** @this {Function} */
react_med.util.round_to_precision.cljs$lang$applyTo = (function (seq15733){
var G__15734 = cljs.core.first.call(null,seq15733);
var seq15733__$1 = cljs.core.next.call(null,seq15733);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15734,seq15733__$1);
});
 ...
 *   tion.
 */
react_med.util.side_effect_component = (function react_med$util$side_effect_component(p__15742){
...
var side_effect = cljs.core.get.call(null,map__15743__$1,new cljs.core.Keyword(null,"side-effect","side-effect",-949778885));
var subscription = cljs.core.get.call(null,map__15743__$1,new cljs.core.Keyword(null,"subscription","subscription",1949009182));
...
return cljs.core.some.call(null,(function (p1__15745_SHARP_){
if(cljs.core.truth_(f.call(null,p1__15745_SHARP_))){
return p1__15745_SHARP_;
} else {
return null;
}
}),coll);
...
var vec__15746 = cljs.core.re_find.call(null,/(\d{4})\D(\d{1,2})\D(\d{1,2})/,date);
var _ = cljs.core.nth.call(null,vec__15746,(0),null);
var year = cljs.core.nth.call(null,vec__15746,(1),null);
