...
react_med.routes.set_route = (function react_med$routes$set_route(app_state,p__20021){
var vec__20022 = p__20021;
var _ = cljs.core.nth.call(null,vec__20022,(0),null);
var ui_route = cljs.core.nth.call(null,vec__20022,(1),null);
...
return result__19140__auto__;
}catch (e20025){var e = e20025;
throw e;
}});
} else {
react_med.routes.set_route = (function react_med$routes$set_route(app_state,p__20026){
var vec__20027 = p__20026;
var _ = cljs.core.nth.call(null,vec__20027,(0),null);
var ui_route = cljs.core.nth.call(null,vec__20027,(1),null);
...
react_med.routes.next_state_handler = (function react_med$routes$next_state_handler(db,p__20030){
var vec__20031 = p__20030;
var event = cljs.core.nth.call(null,vec__20031,(0),null);
...
return (function (p__20038,p__20039){
var map__20040 = p__20038;
var map__20040__$1 = (((((!((map__20040 == null))))?(((((map__20040.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20040.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20040):map__20040);
var app_state = cljs.core.get.call(null,map__20040__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__20041 = p__20039;
var event = cljs.core.nth.call(null,vec__20041,(0),null);
var _ = cljs.core.nth.call(null,vec__20041,(1),null);
...
break;
case "coleta":
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"label","label",1718410804),react_med.routes.tab_title.call(null,"coleta"),new cljs.core.Keyword(null,"state","state",-1988618099),"coleta"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"label","label",1718410804),react_med.routes.tab_title.call(null,"relatorio"),new cljs.core.Keyword(null,"state","state",-1988618099),"relatorio"], null)], null);

break;
case "edit-coleta":
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"label","label",1718410804),react_med.routes.tab_title.call(null,"coleta"),new cljs.core.Keyword(null,"state","state",-1988618099),"edit-coleta"], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"label","label",1718410804),react_med.routes.tab_title.call(null,"relatorio"),new cljs.core.Keyword(null,"state","state",-1988618099),"relatorio"], null)], null);
...
react_med.routes.side_menu = (function react_med$routes$side_menu(p__20059){
var vec__20060 = p__20059;
var state = cljs.core.nth.call(null,vec__20060,(0),null);
var selected_patient = cljs.core.nth.call(null,vec__20060,(1),null);
var selected_avaliacao = cljs.core.nth.call(null,vec__20060,(2),null);
var vec__20063 = cljs.core.re_find.call(null,/\d+-(\d+)-(\d+)/,(function (){var or__4131__auto__ = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(selected_avaliacao);
...
var month = cljs.core.nth.call(null,vec__20063,(1),null);
var day = cljs.core.nth.call(null,vec__20063,(2),null);
var model__GT_menu = ((function (vec__20063,_,month,day,vec__20060,state,selected_patient,selected_avaliacao){
return (function react_med$routes$side_menu_$_m__GT_m(p__20066){
var map__20067 = p__20066;
var map__20067__$1 = (((((!((map__20067 == null))))?(((((map__20067.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20067.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20067):map__20067);
var s = cljs.core.get.call(null,map__20067__$1,new cljs.core.Keyword(null,"s","s",1705939918));
var sub_menus = cljs.core.get.call(null,map__20067__$1,new cljs.core.Keyword(null,"sub-menus","sub-menus",-230507979));
var extra_label = cljs.core.get.call(null,map__20067__$1,new cljs.core.Keyword(null,"extra-label","extra-label",1842953888));
...
});})(vec__20063,_,month,day,vec__20060,state,selected_patient,selected_avaliacao))
;
var menu_model = (function (){var pred__20069 = ((function (vec__20063,_,month,day,model__GT_menu,vec__20060,state,selected_patient,selected_avaliacao){
return (function (p1__20057_SHARP_,p2__20058_SHARP_){
return p1__20057_SHARP_.call(null,p2__20058_SHARP_);
});})(vec__20063,_,month,day,model__GT_menu,vec__20060,state,selected_patient,selected_avaliacao))
;
var expr__20070 = state;
if(cljs.core.truth_(pred__20069.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, ["pacientes",null], null), null),expr__20070))){
...
if(cljs.core.truth_(pred__20069.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["info",null,"avaliacoes",null,"edit-info",null], null), null),expr__20070))){
...
if(cljs.core.truth_(pred__20069.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["coleta",null,"relatorio",null,"edit-coleta",null], null), null),expr__20070))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"s","s",1705939918),"pacientes",new cljs.core.Keyword(null,"extra-label","extra-label",1842953888),(cljs.core.truth_(selected_patient)?[" (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"nome","nome",1100401122).cljs$core$IFn$_invoke$arity$1(selected_patient)),")"].join(''):null),new cljs.core.Keyword(null,"sub-menus","sub-menus",-230507979),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"s","s",1705939918),"info"], null),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"s","s",1705939918),"avaliacoes",new cljs.core.Keyword(null,"extra-label","extra-label",1842953888),(cljs.core.truth_(selected_avaliacao)?[" (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(day),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(month),")"].join(''):null),new cljs.core.Keyword(null,"sub-menus","sub-menus",-230507979),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"s","s",1705939918),"coleta"], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"s","s",1705939918),"relatorio"], null)], null)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"s","s",1705939918),"ellipses"], null)], null);
} else {
if(cljs.core.truth_(pred__20069.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["ellipses",null,"ellipses-config",null], null), null),expr__20070))){
...
var G__20074 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.routes","state","react-med.routes/state",1226363239)], null));
switch (G__20074) {
case "pacientes":
