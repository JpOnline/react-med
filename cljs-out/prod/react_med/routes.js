...
react_med.routes.set_route = (function react_med$routes$set_route(app_state,p__20001){
var vec__20002 = p__20001;
var _ = cljs.core.nth.call(null,vec__20002,(0),null);
var ui_route = cljs.core.nth.call(null,vec__20002,(1),null);
...
return result__19140__auto__;
}catch (e20005){var e = e20005;
throw e;
}});
} else {
react_med.routes.set_route = (function react_med$routes$set_route(app_state,p__20006){
var vec__20007 = p__20006;
var _ = cljs.core.nth.call(null,vec__20007,(0),null);
var ui_route = cljs.core.nth.call(null,vec__20007,(1),null);
...
react_med.routes.next_state_handler = (function react_med$routes$next_state_handler(db,p__20010){
var vec__20011 = p__20010;
var event = cljs.core.nth.call(null,vec__20011,(0),null);
...
return (function (p__20018,p__20019){
var map__20020 = p__20018;
var map__20020__$1 = (((((!((map__20020 == null))))?(((((map__20020.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20020.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20020):map__20020);
var app_state = cljs.core.get.call(null,map__20020__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__20021 = p__20019;
var event = cljs.core.nth.call(null,vec__20021,(0),null);
var _ = cljs.core.nth.call(null,vec__20021,(1),null);
...
react_med.routes.title = (function react_med$routes$title(p__20025){
var vec__20026 = p__20025;
var state = cljs.core.nth.call(null,vec__20026,(0),null);
var selected_patient = cljs.core.nth.call(null,vec__20026,(1),null);
...
react_med.routes.side_menu = (function react_med$routes$side_menu(p__20039){
var vec__20040 = p__20039;
var state = cljs.core.nth.call(null,vec__20040,(0),null);
var selected_patient = cljs.core.nth.call(null,vec__20040,(1),null);
var selected_avaliacao = cljs.core.nth.call(null,vec__20040,(2),null);
var vec__20043 = cljs.core.re_find.call(null,/\d+-(\d+)-(\d+)/,(function (){var or__4131__auto__ = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(selected_avaliacao);
...
var _ = cljs.core.nth.call(null,vec__20043,(0),null);
var month = cljs.core.nth.call(null,vec__20043,(1),null);
var day = cljs.core.nth.call(null,vec__20043,(2),null);
var model__GT_menu = ((function (vec__20043,_,month,day,vec__20040,state,selected_patient,selected_avaliacao){
return (function react_med$routes$side_menu_$_m__GT_m(p__20046){
...
var s = cljs.core.get.call(null,map__20047__$1,new cljs.core.Keyword(null,"s","s",1705939918));
var sub_menus = cljs.core.get.call(null,map__20047__$1,new cljs.core.Keyword(null,"sub-menus","sub-menus",-230507979));
var extra_label = cljs.core.get.call(null,map__20047__$1,new cljs.core.Keyword(null,"extra-label","extra-label",1842953888));
...
});})(vec__20043,_,month,day,vec__20040,state,selected_patient,selected_avaliacao))
;
var menu_model = (function (){var pred__20049 = ((function (vec__20043,_,month,day,model__GT_menu,vec__20040,state,selected_patient,selected_avaliacao){
return (function (p1__20037_SHARP_,p2__20038_SHARP_){
return p1__20037_SHARP_.call(null,p2__20038_SHARP_);
});})(vec__20043,_,month,day,model__GT_menu,vec__20040,state,selected_patient,selected_avaliacao))
;
var expr__20050 = state;
if(cljs.core.truth_(pred__20049.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, ["pacientes",null], null), null),expr__20050))){
...
if(cljs.core.truth_(pred__20049.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["info",null,"avaliacoes",null,"edit-info",null], null), null),expr__20050))){
...
if(cljs.core.truth_(pred__20049.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["coleta",null,"relatorio",null,"edit-coleta",null], null), null),expr__20050))){
...
if(cljs.core.truth_(pred__20049.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["ellipses",null,"ellipses-config",null], null), null),expr__20050))){
...
var G__20054 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.routes","state","react-med.routes/state",1226363239)], null));
switch (G__20054) {
case "pacientes":
