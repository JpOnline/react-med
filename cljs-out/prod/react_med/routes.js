...
react_med.routes.set_route = (function react_med$routes$set_route(app_state,p__20011){
var vec__20012 = p__20011;
var _ = cljs.core.nth.call(null,vec__20012,(0),null);
var ui_route = cljs.core.nth.call(null,vec__20012,(1),null);
...
react_med.routes.set_route = (function react_med$routes$set_route(app_state,p__20016){
var vec__20017 = p__20016;
var _ = cljs.core.nth.call(null,vec__20017,(0),null);
var ui_route = cljs.core.nth.call(null,vec__20017,(1),null);
...
react_med.routes.next_state_handler = (function react_med$routes$next_state_handler(db,p__20020){
...
return (function (p__20028,p__20029){
var map__20030 = p__20028;
var map__20030__$1 = (((((!((map__20030 == null))))?(((((map__20030.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20030.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20030):map__20030);
var app_state = cljs.core.get.call(null,map__20030__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__20031 = p__20029;
var event = cljs.core.nth.call(null,vec__20031,(0),null);
var _ = cljs.core.nth.call(null,vec__20031,(1),null);
...
react_med.routes.title = (function react_med$routes$title(p__20035){
var vec__20036 = p__20035;
var state = cljs.core.nth.call(null,vec__20036,(0),null);
var selected_patient = cljs.core.nth.call(null,vec__20036,(1),null);
...
react_med.routes.side_menu = (function react_med$routes$side_menu(p__20049){
var vec__20050 = p__20049;
var state = cljs.core.nth.call(null,vec__20050,(0),null);
var selected_patient = cljs.core.nth.call(null,vec__20050,(1),null);
var selected_avaliacao = cljs.core.nth.call(null,vec__20050,(2),null);
var vec__20053 = cljs.core.re_find.call(null,/\d+-(\d+)-(\d+)/,(function (){var or__4131__auto__ = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(selected_avaliacao);
...
var month = cljs.core.nth.call(null,vec__20053,(1),null);
var day = cljs.core.nth.call(null,vec__20053,(2),null);
var model__GT_menu = ((function (vec__20053,_,month,day,vec__20050,state,selected_patient,selected_avaliacao){
return (function react_med$routes$side_menu_$_m__GT_m(p__20056){
...
var s = cljs.core.get.call(null,map__20057__$1,new cljs.core.Keyword(null,"s","s",1705939918));
var sub_menus = cljs.core.get.call(null,map__20057__$1,new cljs.core.Keyword(null,"sub-menus","sub-menus",-230507979));
var extra_label = cljs.core.get.call(null,map__20057__$1,new cljs.core.Keyword(null,"extra-label","extra-label",1842953888));
...
});})(vec__20053,_,month,day,vec__20050,state,selected_patient,selected_avaliacao))
;
var menu_model = (function (){var pred__20059 = ((function (vec__20053,_,month,day,model__GT_menu,vec__20050,state,selected_patient,selected_avaliacao){
return (function (p1__20047_SHARP_,p2__20048_SHARP_){
return p1__20047_SHARP_.call(null,p2__20048_SHARP_);
});})(vec__20053,_,month,day,model__GT_menu,vec__20050,state,selected_patient,selected_avaliacao))
;
var expr__20060 = state;
if(cljs.core.truth_(pred__20059.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, ["pacientes",null], null), null),expr__20060))){
...
if(cljs.core.truth_(pred__20059.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["info",null,"avaliacoes",null,"edit-info",null], null), null),expr__20060))){
...
if(cljs.core.truth_(pred__20059.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["coleta",null,"relatorio",null,"edit-coleta",null], null), null),expr__20060))){
...
if(cljs.core.truth_(pred__20059.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["ellipses",null,"ellipses-config",null], null), null),expr__20060))){
...
var G__20064 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.routes","state","react-med.routes/state",1226363239)], null));
switch (G__20064) {
case "pacientes":
