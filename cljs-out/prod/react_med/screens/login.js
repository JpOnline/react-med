...
react_med.screens.login.set_login_property = (function react_med$screens$login$set_login_property(app_state,p__19499){
var vec__19500 = p__19499;
var event = cljs.core.nth.call(null,vec__19500,(0),null);
var property = cljs.core.nth.call(null,vec__19500,(1),null);
var value = cljs.core.nth.call(null,vec__19500,(2),null);
 ...
 */
react_med.screens.login.set_login_property = (function react_med$screens$login$set_login_property(app_state,p__19504){
var vec__19505 = p__19504;
var event = cljs.core.nth.call(null,vec__19505,(0),null);
var property = cljs.core.nth.call(null,vec__19505,(1),null);
var value = cljs.core.nth.call(null,vec__19505,(2),null);
...
}),(cljs.core.truth_(react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.login","email-error","react-med.screens.login/email-error",-231845183)], null)))?new cljs.core.Keyword(null,"invalid","invalid",412869516):null),(cljs.core.truth_(react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.login","email-error","react-med.screens.login/email-error",-231845183)], null)))?true:null),"error-message",react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.login","email-error","react-med.screens.login/email-error",-231845183)], null)),new cljs.core.Keyword(null,"value","value",305978217),react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.login","email","react-med.screens.login/email",-1991830816)], null)),new cljs.core.Keyword(null,"onBlur","onBlur",229342509),(function (p1__19509_SHARP_){
return react_med.util._GT_evt.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.login","set-login-property","react-med.screens.login/set-login-property",-2145751329),new cljs.core.Keyword(null,"email","email",1415816706),p1__19509_SHARP_.target.value], null));
