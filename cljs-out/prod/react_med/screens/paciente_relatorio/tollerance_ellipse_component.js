...
var len__4730__auto___19682 = arguments.length;
var i__4731__auto___19683 = (0);
while(true){
if((i__4731__auto___19683 < len__4730__auto___19682)){
args__4736__auto__.push((arguments[i__4731__auto___19683]));

var G__19684 = (i__4731__auto___19683 + (1));
i__4731__auto___19683 = G__19684;
continue;
} else {
}
break;
...
var x = cljs.core.nth.call(null,vec__19679,(0),null);
var y = cljs.core.nth.call(null,vec__19679,(1),null);
...
/** @this {Function} */
react_med.screens.paciente_relatorio.tollerance_ellipse_component.series_points__GT_data_array.cljs$lang$applyTo = (function (seq19676){
var G__19677 = cljs.core.first.call(null,seq19676);
var seq19676__$1 = cljs.core.next.call(null,seq19676);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19677,seq19676__$1);
});

react_med.screens.paciente_relatorio.tollerance_ellipse_component.ellipse = (function react_med$screens$paciente_relatorio$tollerance_ellipse_component$ellipse(name,p__19688,radius_x,radius_y,rotation){
var vec__19689 = p__19688;
var cx = cljs.core.nth.call(null,vec__19689,(0),null);
var cy = cljs.core.nth.call(null,vec__19689,(1),null);
var t = (((rotation === (0)))?(0):(Math.PI / ((180) / rotation)));
return cljs.core.cons.call(null,name,cljs.core.map.call(null,((function (t,vec__19689,cx,cy){
return (function (p1__19687_SHARP_){
return cljs.core.map.call(null,cljs.core._PLUS_,p1__19687_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cx,cy], null));
});})(t,vec__19689,cx,cy))
,cljs.core.map.call(null,((function (t,vec__19689,cx,cy){
return (function (p__19692){
var vec__19693 = p__19692;
var x = cljs.core.nth.call(null,vec__19693,(0),null);
var y = cljs.core.nth.call(null,vec__19693,(1),null);
...
return cljs.core.map.call(null,cljs.core._,p1__19686_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cx,cy], null));
});})(t,vec__19689,cx,cy))
,cljs.core.map.call(null,((function (t,vec__19689,cx,cy){
return (function (p1__19685_SHARP_){
return cljs.core.into.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cx + (Math.cos(p1__19685_SHARP_) * radius_x)),(cy + (Math.sin(p1__19685_SHARP_) * radius_y))], null));
});})(t,vec__19689,cx,cy))
 ...
 */
react_med.screens.paciente_relatorio.tollerance_ellipse_component.eigen_val = (function react_med$screens$paciente_relatorio$tollerance_ellipse_component$eigen_val(p__19696){
var vec__19697 = p__19696;
var vec__19700 = cljs.core.nth.call(null,vec__19697,(0),null);
var a = cljs.core.nth.call(null,vec__19700,(0),null);
var b = cljs.core.nth.call(null,vec__19700,(1),null);
var vec__19703 = cljs.core.nth.call(null,vec__19697,(1),null);
var c = cljs.core.nth.call(null,vec__19703,(0),null);
var d = cljs.core.nth.call(null,vec__19703,(1),null);
var trace = (a + d);
...
var vec__19706 = react_med.screens.paciente_relatorio.tollerance_ellipse_component.eigen_val.call(null,matrix_2x2);
var val1 = cljs.core.nth.call(null,vec__19706,(0),null);
var val2 = cljs.core.nth.call(null,vec__19706,(1),null);
var vec__19709 = matrix_2x2;
var vec__19712 = cljs.core.nth.call(null,vec__19709,(0),null);
var a = cljs.core.nth.call(null,vec__19712,(0),null);
var b = cljs.core.nth.call(null,vec__19712,(1),null);
var vec__19715 = cljs.core.nth.call(null,vec__19709,(1),null);
var c = cljs.core.nth.call(null,vec__19715,(0),null);
var d = cljs.core.nth.call(null,vec__19715,(1),null);
if((((c === (0))) && ((b === (0))))){
...
var vec__19720 = react_med.screens.paciente_relatorio.tollerance_ellipse_component.eigen_vec.call(null,covariance_matrix);
var vec__19723 = cljs.core.nth.call(null,vec__19720,(0),null);
var eigen_vec_1_x = cljs.core.nth.call(null,vec__19723,(0),null);
var eigen_vec_2_x = cljs.core.nth.call(null,vec__19723,(1),null);
var vec__19726 = cljs.core.nth.call(null,vec__19720,(1),null);
var eigen_vec_1_y = cljs.core.nth.call(null,vec__19726,(0),null);
var eigen_vec_2_y = cljs.core.nth.call(null,vec__19726,(1),null);
var vec__19729 = react_med.screens.paciente_relatorio.tollerance_ellipse_component.eigen_val.call(null,covariance_matrix);
var eigen_val_x = cljs.core.nth.call(null,vec__19729,(0),null);
var eigen_val_y = cljs.core.nth.call(null,vec__19729,(1),null);
...
var x_semi_axes = cljs.core.map.call(null,((function (covxy,covyx,covxx,covyy,covariance_matrix,vec__19720,vec__19723,eigen_vec_1_x,eigen_vec_2_x,vec__19726,eigen_vec_1_y,eigen_vec_2_y,vec__19729,eigen_val_x,eigen_val_y,chi_squared,tolerances){
return (function (p1__19718_SHARP_){
return Math.sqrt((p1__19718_SHARP_ * eigen_val_x));
});})(covxy,covyx,covxx,covyy,covariance_matrix,vec__19720,vec__19723,eigen_vec_1_x,eigen_vec_2_x,vec__19726,eigen_vec_1_y,eigen_vec_2_y,vec__19729,eigen_val_x,eigen_val_y,chi_squared,tolerances))
,tolerances);
var y_semi_axes = cljs.core.map.call(null,((function (covxy,covyx,covxx,covyy,covariance_matrix,vec__19720,vec__19723,eigen_vec_1_x,eigen_vec_2_x,vec__19726,eigen_vec_1_y,eigen_vec_2_y,vec__19729,eigen_val_x,eigen_val_y,chi_squared,tolerances,x_semi_axes){
return (function (p1__19719_SHARP_){
return Math.sqrt((p1__19719_SHARP_ * eigen_val_y));
});})(covxy,covyx,covxx,covyy,covariance_matrix,vec__19720,vec__19723,eigen_vec_1_x,eigen_vec_2_x,vec__19726,eigen_vec_1_y,eigen_vec_2_y,vec__19729,eigen_val_x,eigen_val_y,chi_squared,tolerances,x_semi_axes))
,tolerances);
...
react_med.screens.paciente_relatorio.tollerance_ellipse_component.ellipse_chart_component = (function react_med$screens$paciente_relatorio$tollerance_ellipse_component$ellipse_chart_component(p__19732){
...
var width = cljs.core.get.call(null,map__19733__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__19733__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var series = cljs.core.get.call(null,map__19733__$1,new cljs.core.Keyword(null,"series","series",600710694));
var options = cljs.core.get.call(null,map__19733__$1,new cljs.core.Keyword(null,"options","options",99638489));
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [react_med.util.with_mount_fn.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"style","style",-496642736),({"height": height, "width": width}),new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),react_med.screens.paciente_relatorio.tollerance_ellipse_component.draw_chart.call(null,id,data_array,options)], null)], null))], null);
});
react_med.screens.paciente_relatorio.tollerance_ellipse_component.ellipse_chart_component2 = (function react_med$screens$paciente_relatorio$tollerance_ellipse_component$ellipse_chart_component2(p__19735){
...
var style = cljs.core.get.call(null,map__19736__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var height = cljs.core.get.call(null,map__19736__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var series = cljs.core.get.call(null,map__19736__$1,new cljs.core.Keyword(null,"series","series",600710694));
var options = cljs.core.get.call(null,map__19736__$1,new cljs.core.Keyword(null,"options","options",99638489));
var id = ["ellipse-chart",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid.call(null))].join('');
var data_array = cljs.core.apply.call(null,react_med.screens.paciente_relatorio.tollerance_ellipse_component.series_points__GT_data_array,"x definido em ellipse-chart-comp",series);
