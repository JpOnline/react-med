...
var len__4730__auto___15620 = arguments.length;
var i__4731__auto___15621 = (0);
while(true){
if((i__4731__auto___15621 < len__4730__auto___15620)){
args__4736__auto__.push((arguments[i__4731__auto___15621]));

var G__15622 = (i__4731__auto___15621 + (1));
i__4731__auto___15621 = G__15622;
continue;
} else {
}
break;
...
return (function (p__15616){
var vec__15617 = p__15616;
var x = cljs.core.nth.call(null,vec__15617,(0),null);
var y = cljs.core.nth.call(null,vec__15617,(1),null);
...
/** @this {Function} */
react_med.screens.paciente_relatorio.tollerance_ellipse_component.series_points__GT_data_array.cljs$lang$applyTo = (function (seq15614){
var G__15615 = cljs.core.first.call(null,seq15614);
var seq15614__$1 = cljs.core.next.call(null,seq15614);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15615,seq15614__$1);
});

react_med.screens.paciente_relatorio.tollerance_ellipse_component.ellipse = (function react_med$screens$paciente_relatorio$tollerance_ellipse_component$ellipse(name,p__15626,radius_x,radius_y,rotation){
var vec__15627 = p__15626;
var cx = cljs.core.nth.call(null,vec__15627,(0),null);
var cy = cljs.core.nth.call(null,vec__15627,(1),null);
var t = (((rotation === (0)))?(0):(Math.PI / ((180) / rotation)));
return cljs.core.cons.call(null,name,cljs.core.map.call(null,((function (t,vec__15627,cx,cy){
return (function (p1__15625_SHARP_){
return cljs.core.map.call(null,cljs.core._PLUS_,p1__15625_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cx,cy], null));
});})(t,vec__15627,cx,cy))
,cljs.core.map.call(null,((function (t,vec__15627,cx,cy){
return (function (p__15630){
var vec__15631 = p__15630;
var x = cljs.core.nth.call(null,vec__15631,(0),null);
var y = cljs.core.nth.call(null,vec__15631,(1),null);
...
return cljs.core.map.call(null,cljs.core._,p1__15624_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cx,cy], null));
});})(t,vec__15627,cx,cy))
,cljs.core.map.call(null,((function (t,vec__15627,cx,cy){
return (function (p1__15623_SHARP_){
return cljs.core.into.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cx + (Math.cos(p1__15623_SHARP_) * radius_x)),(cy + (Math.sin(p1__15623_SHARP_) * radius_y))], null));
});})(t,vec__15627,cx,cy))
 ...
 */
react_med.screens.paciente_relatorio.tollerance_ellipse_component.eigen_val = (function react_med$screens$paciente_relatorio$tollerance_ellipse_component$eigen_val(p__15634){
var vec__15635 = p__15634;
var vec__15638 = cljs.core.nth.call(null,vec__15635,(0),null);
var a = cljs.core.nth.call(null,vec__15638,(0),null);
var b = cljs.core.nth.call(null,vec__15638,(1),null);
var vec__15641 = cljs.core.nth.call(null,vec__15635,(1),null);
var c = cljs.core.nth.call(null,vec__15641,(0),null);
var d = cljs.core.nth.call(null,vec__15641,(1),null);
var trace = (a + d);
...
var vec__15644 = react_med.screens.paciente_relatorio.tollerance_ellipse_component.eigen_val.call(null,matrix_2x2);
var val1 = cljs.core.nth.call(null,vec__15644,(0),null);
var val2 = cljs.core.nth.call(null,vec__15644,(1),null);
var vec__15647 = matrix_2x2;
var vec__15650 = cljs.core.nth.call(null,vec__15647,(0),null);
var a = cljs.core.nth.call(null,vec__15650,(0),null);
var b = cljs.core.nth.call(null,vec__15650,(1),null);
var vec__15653 = cljs.core.nth.call(null,vec__15647,(1),null);
var c = cljs.core.nth.call(null,vec__15653,(0),null);
var d = cljs.core.nth.call(null,vec__15653,(1),null);
if((((c === (0))) && ((b === (0))))){
...
var vec__15658 = react_med.screens.paciente_relatorio.tollerance_ellipse_component.eigen_vec.call(null,covariance_matrix);
var vec__15661 = cljs.core.nth.call(null,vec__15658,(0),null);
var eigen_vec_1_x = cljs.core.nth.call(null,vec__15661,(0),null);
var eigen_vec_2_x = cljs.core.nth.call(null,vec__15661,(1),null);
var vec__15664 = cljs.core.nth.call(null,vec__15658,(1),null);
var eigen_vec_1_y = cljs.core.nth.call(null,vec__15664,(0),null);
var eigen_vec_2_y = cljs.core.nth.call(null,vec__15664,(1),null);
var vec__15667 = react_med.screens.paciente_relatorio.tollerance_ellipse_component.eigen_val.call(null,covariance_matrix);
var eigen_val_x = cljs.core.nth.call(null,vec__15667,(0),null);
var eigen_val_y = cljs.core.nth.call(null,vec__15667,(1),null);
...
var x_semi_axes = cljs.core.map.call(null,((function (covxy,covyx,covxx,covyy,covariance_matrix,vec__15658,vec__15661,eigen_vec_1_x,eigen_vec_2_x,vec__15664,eigen_vec_1_y,eigen_vec_2_y,vec__15667,eigen_val_x,eigen_val_y,chi_squared,tolerances){
return (function (p1__15656_SHARP_){
return Math.sqrt((p1__15656_SHARP_ * eigen_val_x));
});})(covxy,covyx,covxx,covyy,covariance_matrix,vec__15658,vec__15661,eigen_vec_1_x,eigen_vec_2_x,vec__15664,eigen_vec_1_y,eigen_vec_2_y,vec__15667,eigen_val_x,eigen_val_y,chi_squared,tolerances))
,tolerances);
var y_semi_axes = cljs.core.map.call(null,((function (covxy,covyx,covxx,covyy,covariance_matrix,vec__15658,vec__15661,eigen_vec_1_x,eigen_vec_2_x,vec__15664,eigen_vec_1_y,eigen_vec_2_y,vec__15667,eigen_val_x,eigen_val_y,chi_squared,tolerances,x_semi_axes){
return (function (p1__15657_SHARP_){
return Math.sqrt((p1__15657_SHARP_ * eigen_val_y));
});})(covxy,covyx,covxx,covyy,covariance_matrix,vec__15658,vec__15661,eigen_vec_1_x,eigen_vec_2_x,vec__15664,eigen_vec_1_y,eigen_vec_2_y,vec__15667,eigen_val_x,eigen_val_y,chi_squared,tolerances,x_semi_axes))
,tolerances);
...
react_med.screens.paciente_relatorio.tollerance_ellipse_component.ellipse_chart_component = (function react_med$screens$paciente_relatorio$tollerance_ellipse_component$ellipse_chart_component(p__15670){
...
var width = cljs.core.get.call(null,map__15671__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__15671__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var series = cljs.core.get.call(null,map__15671__$1,new cljs.core.Keyword(null,"series","series",600710694));
...
react_med.screens.paciente_relatorio.tollerance_ellipse_component.ellipse_chart_component2 = (function react_med$screens$paciente_relatorio$tollerance_ellipse_component$ellipse_chart_component2(p__15673){
...
var style = cljs.core.get.call(null,map__15674__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var height = cljs.core.get.call(null,map__15674__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var series = cljs.core.get.call(null,map__15674__$1,new cljs.core.Keyword(null,"series","series",600710694));
var options = cljs.core.get.call(null,map__15674__$1,new cljs.core.Keyword(null,"options","options",99638489));
var id = ["ellipse-chart",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.random_uuid.call(null))].join('');
var data_array = cljs.core.apply.call(null,react_med.screens.paciente_relatorio.tollerance_ellipse_component.series_points__GT_data_array,"x definido em ellipse-chart-comp",series);
