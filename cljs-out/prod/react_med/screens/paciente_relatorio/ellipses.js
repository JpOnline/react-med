...
var map__19791 = react_med.util.get_pred.call(null,(function (p1__19790_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"population","population",-1209901867).cljs$core$IFn$_invoke$arity$1(p1__19790_SHARP_),chosen_population);
...
var rsp_mean = cljs.core.get.call(null,map__19791__$1,new cljs.core.Keyword(null,"rsp-mean","rsp-mean",733542564));
var xcsp_mean = cljs.core.get.call(null,map__19791__$1,new cljs.core.Keyword(null,"xcsp-mean","xcsp-mean",-1168783083));
var rsp_sd = cljs.core.get.call(null,map__19791__$1,new cljs.core.Keyword(null,"rsp-sd","rsp-sd",1061002629));
var xcsp_sd = cljs.core.get.call(null,map__19791__$1,new cljs.core.Keyword(null,"xcsp-sd","xcsp-sd",633266882));
var correlation_r = cljs.core.get.call(null,map__19791__$1,new cljs.core.Keyword(null,"correlation-r","correlation-r",2086447628));
var vec__19792 = react_med.screens.paciente_relatorio.tollerance_ellipse_component.tolerance_ellipses_params.call(null,rsp_sd,xcsp_sd,correlation_r);
var vec__19795 = cljs.core.nth.call(null,vec__19792,(0),null);
var tol_50_x = cljs.core.nth.call(null,vec__19795,(0),null);
var tol_75_x = cljs.core.nth.call(null,vec__19795,(1),null);
var tol_95_x = cljs.core.nth.call(null,vec__19795,(2),null);
var vec__19798 = cljs.core.nth.call(null,vec__19792,(1),null);
var tol_50_y = cljs.core.nth.call(null,vec__19798,(0),null);
var tol_75_y = cljs.core.nth.call(null,vec__19798,(1),null);
var tol_95_y = cljs.core.nth.call(null,vec__19798,(2),null);
var rotation = cljs.core.nth.call(null,vec__19792,(2),null);
...
return cljs.core.filter.call(null,new cljs.core.Keyword(null,"checked?","checked?",2024809091),cljs.core.map.call(null,(function (p__19802){
...
var id = cljs.core.get.call(null,map__19803__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var reatancia = cljs.core.get.call(null,map__19803__$1,new cljs.core.Keyword(null,"reatancia","reatancia",1544866627));
var resistencia = cljs.core.get.call(null,map__19803__$1,new cljs.core.Keyword(null,"resistencia","resistencia",1922766858));
var data = cljs.core.get.call(null,map__19803__$1,new cljs.core.Keyword(null,"data","data",-232669377));
 ...
 */
react_med.screens.paciente_relatorio.ellipses.pacientes_avaliacoes_pontos = (function react_med$screens$paciente_relatorio$ellipses$pacientes_avaliacoes_pontos(p__19808){
var vec__19809 = p__19808;
var pacientes = cljs.core.nth.call(null,vec__19809,(0),null);
var avals_checked = cljs.core.nth.call(null,vec__19809,(1),null);
return cljs.core.map.call(null,((function (vec__19809,pacientes,avals_checked){
...
var nome = cljs.core.get.call(null,map__19813__$1,new cljs.core.Keyword(null,"nome","nome",1100401122));
var avaliacoes = cljs.core.get.call(null,map__19813__$1,new cljs.core.Keyword(null,"avaliacoes","avaliacoes",-1489161982));
return cljs.core.apply.call(null,cljs.core.concat,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [nome], null),cljs.core.mapv.call(null,((function (map__19813,map__19813__$1,nome,avaliacoes,vec__19809,pacientes,avals_checked){
return (function (p__19815){
...
var resistencia = cljs.core.get.call(null,map__19816__$1,new cljs.core.Keyword(null,"resistencia","resistencia",1922766858));
var reatancia = cljs.core.get.call(null,map__19816__$1,new cljs.core.Keyword(null,"reatancia","reatancia",1544866627));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [resistencia,reatancia], null);
});})(map__19813,map__19813__$1,nome,avaliacoes,vec__19809,pacientes,avals_checked))
,avaliacoes)], null));
});})(vec__19809,pacientes,avals_checked))
,cljs.core.filter.call(null,((function (vec__19809,pacientes,avals_checked){
return (function (p1__19807_SHARP_){
return cljs.core.seq.call(null,new cljs.core.Keyword(null,"avaliacoes","avaliacoes",-1489161982).cljs$core$IFn$_invoke$arity$1(p1__19807_SHARP_));
});})(vec__19809,pacientes,avals_checked))
,cljs.core.map.call(null,((function (vec__19809,pacientes,avals_checked){
return (function (p1__19806_SHARP_){
return cljs.core.update_in.call(null,p1__19806_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"avaliacoes","avaliacoes",-1489161982)], null),react_med.screens.paciente_relatorio.ellipses.filter_selected,cljs.core.get_in.call(null,avals_checked,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__19806_SHARP_),new cljs.core.Keyword(null,"avals","avals",659695120)], null)));
});})(vec__19809,pacientes,avals_checked))
,cljs.core.map.call(null,((function (vec__19809,pacientes,avals_checked){
return (function (p1__19805_SHARP_){
return cljs.core.select_keys.call(null,p1__19805_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"nome","nome",1100401122),new cljs.core.Keyword(null,"avaliacoes","avaliacoes",-1489161982)], null));
});})(vec__19809,pacientes,avals_checked))
,pacientes))));
});
...
react_med.screens.paciente_relatorio.ellipses.ellipses_graph_series = (function react_med$screens$paciente_relatorio$ellipses$ellipses_graph_series(p__19818){
var vec__19819 = p__19818;
var ellipses = cljs.core.nth.call(null,vec__19819,(0),null);
var pacientes_pontos = cljs.core.nth.call(null,vec__19819,(1),null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.top-bar","div.top-bar",-1606146455),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),({"minHeight": (48), "padding": "0 24px", "display": "flex", "alignItems": "center"})], null),cljs.core.map_indexed.call(null,(function (p1__19823_SHARP_,p2__19822_SHARP_){
return cljs.core.with_meta.call(null,p2__19822_SHARP_,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),p1__19823_SHARP_], null));
}),children)], null);
});
...
/** @this {Function} */
react_med.screens.paciente_relatorio.ellipses.top_bar.cljs$lang$applyTo = (function (seq19824){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq19824));
});
