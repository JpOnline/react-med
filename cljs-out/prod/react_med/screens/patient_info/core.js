...
var vec__14886 = cljs.core.re_find.call(null,/(\d{4})\D(\d{1,2})\D(\d{1,2})/,date);
var _ = cljs.core.nth.call(null,vec__14886,(0),null);
var year = cljs.core.nth.call(null,vec__14886,(1),null);
var month = cljs.core.nth.call(null,vec__14886,(2),null);
var day = cljs.core.nth.call(null,vec__14886,(3),null);
...
react_med.screens.patient_info.core.export_to_csv = (function react_med$screens$patient_info$core$export_to_csv(app_state,p__14889){
var vec__14890 = p__14889;
var event = cljs.core.nth.call(null,vec__14890,(0),null);
...
var map__14893_14895 = react_med.screens.patient_info.core.selected_patient.call(null,app_state);
var map__14893_14896__$1 = (((((!((map__14893_14895 == null))))?(((((map__14893_14895.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14893_14895.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14893_14895):map__14893_14895);
var nome_14897 = cljs.core.get.call(null,map__14893_14896__$1,new cljs.core.Keyword(null,"nome","nome",1100401122));
var nascimento_14898 = cljs.core.get.call(null,map__14893_14896__$1,new cljs.core.Keyword(null,"nascimento","nascimento",646565528));
var sexo_14899 = cljs.core.get.call(null,map__14893_14896__$1,new cljs.core.Keyword(null,"sexo","sexo",-629407757));
var estatura_14900 = cljs.core.get.call(null,map__14893_14896__$1,new cljs.core.Keyword(null,"estatura","estatura",-685084760));
var csv_data_14901 = testdouble.cljs.csv.write_csv.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Nome",nome_14897], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Data de Nascimento",react_med.screens.patient_info.core.yyyy_mm_dd__GT_dd_mm_yyyy.call(null,nascimento_14898)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Sexo",sexo_14899], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Estatura",cljs.core.str.cljs$core$IFn$_invoke$arity$1(estatura_14900).replace(".",",")], null)], null),new cljs.core.Keyword(null,"quote?","quote?",-1114029317),true);
console.log("csv\n",csv_data_14901);

react_med.screens.patient_info.core.share.call(null,csv_data_14901,"teste.csv","text/csv");
...
react_med.screens.patient_info.core.change_patient_name = (function react_med$screens$patient_info$core$change_patient_name(app_state,p__14902){
var vec__14903 = p__14902;
var event = cljs.core.nth.call(null,vec__14903,(0),null);
var new_name = cljs.core.nth.call(null,vec__14903,(1),null);
...
return result__14245__auto__;
}catch (e14906){var e = e14906;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_patient_name = (function react_med$screens$patient_info$core$change_patient_name(app_state,p__14907){
var vec__14908 = p__14907;
var event = cljs.core.nth.call(null,vec__14908,(0),null);
var new_name = cljs.core.nth.call(null,vec__14908,(1),null);
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.screens.patient_info.core.change_birth_date = (function react_med$screens$patient_info$core$change_birth_date(app_state,p__14911){
var vec__14912 = p__14911;
var event = cljs.core.nth.call(null,vec__14912,(0),null);
var new_birth_date = cljs.core.nth.call(null,vec__14912,(1),null);
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
return result__14245__auto__;
}catch (e14915){var e = e14915;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_birth_date = (function react_med$screens$patient_info$core$change_birth_date(app_state,p__14916){
var vec__14917 = p__14916;
var event = cljs.core.nth.call(null,vec__14917,(0),null);
var new_birth_date = cljs.core.nth.call(null,vec__14917,(1),null);
...
var result__14245__auto__ = p1__14920_SHARP_;
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"p1__14920#","p1__14920#",27774343,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(4)], null));

return result__14245__auto__;
})(),"Feminino");
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__14920#","p1__14920#",27774343,null),"Feminino"),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(3)], null));

return result__14245__auto__;
})())?"Masculino":"Feminino");
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__14920#","p1__14920#",27774343,null),"Feminino"),"Masculino","Feminino"),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(2)], null));

return result__14245__auto__;
});})(opts__14244__auto____$1,opts__14244__auto__,_PLUS_debux_dbg_opts_PLUS_))
;
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__14920#","p1__14920#",27774343,null)], null),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__14920#","p1__14920#",27774343,null),"Feminino"),"Masculino","Feminino")),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__14245__auto__;
})());
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"update-in","update-in",-1445516941,null),new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"domain","domain",1847214937),new cljs.core.Keyword(null,"patients","patients",134252075),(0),new cljs.core.Keyword(null,"sexo","sexo",-629407757)], null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__14920#","p1__14920#",27774343,null)], null),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__14920#","p1__14920#",27774343,null),"Feminino"),"Masculino","Feminino"))),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(0)], null));

return result__14245__auto__;
}catch (e14921){var e = e14921;
throw e;
}});
} else {
react_med.screens.patient_info.core.toggle_sexo = (function react_med$screens$patient_info$core$toggle_sexo(app_state){
return cljs.core.update_in.call(null,app_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"domain","domain",1847214937),new cljs.core.Keyword(null,"patients","patients",134252075),(0),new cljs.core.Keyword(null,"sexo","sexo",-629407757)], null),(function (p1__14920_SHARP_){
if(cljs.core._EQ_.call(null,p1__14920_SHARP_,"Feminino")){
return "Masculino";
} else {
return "Feminino";
}
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.screens.patient_info.core.change_height = (function react_med$screens$patient_info$core$change_height(app_state,p__14922){
var vec__14923 = p__14922;
var event = cljs.core.nth.call(null,vec__14923,(0),null);
var new_height = cljs.core.nth.call(null,vec__14923,(1),null);
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
return result__14245__auto__;
}catch (e14926){var e = e14926;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_height = (function react_med$screens$patient_info$core$change_height(app_state,p__14927){
var vec__14928 = p__14927;
var event = cljs.core.nth.call(null,vec__14928,(0),null);
var new_height = cljs.core.nth.call(null,vec__14928,(1),null);
...
var vec__14931 = cljs.core.re_find.call(null,/(\d{1,2})\D(\d{1,2})\D(\d{4})/,text);
var _ = cljs.core.nth.call(null,vec__14931,(0),null);
var d = cljs.core.nth.call(null,vec__14931,(1),null);
var m = cljs.core.nth.call(null,vec__14931,(2),null);
var y = cljs.core.nth.call(null,vec__14931,(3),null);
...
var map__14937 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.patient-info.core","selected-patient","react-med.screens.patient-info.core/selected-patient",-1719364628)], null));
...
var map__14939 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.patient-info.core","selected-patient","react-med.screens.patient-info.core/selected-patient",-1719364628)], null));
...
var nome = cljs.core.get.call(null,map__14939__$1,new cljs.core.Keyword(null,"nome","nome",1100401122));
var nascimento = cljs.core.get.call(null,map__14939__$1,new cljs.core.Keyword(null,"nascimento","nascimento",646565528));
var idade = cljs.core.get.call(null,map__14939__$1,new cljs.core.Keyword(null,"idade","idade",297389078));
var sexo = cljs.core.get.call(null,map__14939__$1,new cljs.core.Keyword(null,"sexo","sexo",-629407757));
var estatura = cljs.core.get.call(null,map__14939__$1,new cljs.core.Keyword(null,"estatura","estatura",-685084760));
...
react_med.screens.patient_info.core.patient_detail = (function react_med$screens$patient_info$core$patient_detail(p__14941,content_view){
var map__14942 = p__14941;
var map__14942__$1 = (((((!((map__14942 == null))))?(((((map__14942.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14942.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14942):map__14942);
var actions = cljs.core.get.call(null,map__14942__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
