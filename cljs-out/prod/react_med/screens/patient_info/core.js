...
var vec__14885 = cljs.core.re_find.call(null,/(\d{4})\D(\d{1,2})\D(\d{1,2})/,date);
var _ = cljs.core.nth.call(null,vec__14885,(0),null);
var year = cljs.core.nth.call(null,vec__14885,(1),null);
var month = cljs.core.nth.call(null,vec__14885,(2),null);
var day = cljs.core.nth.call(null,vec__14885,(3),null);
...
react_med.screens.patient_info.core.export_to_csv = (function react_med$screens$patient_info$core$export_to_csv(app_state,p__14888){
var vec__14889 = p__14888;
var event = cljs.core.nth.call(null,vec__14889,(0),null);
...
var map__14892_14894 = react_med.screens.patient_info.core.selected_patient.call(null,app_state);
var map__14892_14895__$1 = (((((!((map__14892_14894 == null))))?(((((map__14892_14894.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14892_14894.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14892_14894):map__14892_14894);
var nome_14896 = cljs.core.get.call(null,map__14892_14895__$1,new cljs.core.Keyword(null,"nome","nome",1100401122));
var nascimento_14897 = cljs.core.get.call(null,map__14892_14895__$1,new cljs.core.Keyword(null,"nascimento","nascimento",646565528));
var sexo_14898 = cljs.core.get.call(null,map__14892_14895__$1,new cljs.core.Keyword(null,"sexo","sexo",-629407757));
var estatura_14899 = cljs.core.get.call(null,map__14892_14895__$1,new cljs.core.Keyword(null,"estatura","estatura",-685084760));
var csv_data_14900 = testdouble.cljs.csv.write_csv.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Nome",nome_14896], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Data de Nascimento",react_med.screens.patient_info.core.yyyy_mm_dd__GT_dd_mm_yyyy.call(null,nascimento_14897)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Sexo",sexo_14898], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Estatura",cljs.core.str.cljs$core$IFn$_invoke$arity$1(estatura_14899).replace(".",",")], null)], null),new cljs.core.Keyword(null,"quote?","quote?",-1114029317),true);
console.log("csv\n",csv_data_14900);

react_med.screens.patient_info.core.download.call(null,csv_data_14900,"teste.csv","text/csv");
...
react_med.screens.patient_info.core.change_patient_name = (function react_med$screens$patient_info$core$change_patient_name(app_state,p__14901){
var vec__14902 = p__14901;
var event = cljs.core.nth.call(null,vec__14902,(0),null);
var new_name = cljs.core.nth.call(null,vec__14902,(1),null);
...
return result__14245__auto__;
}catch (e14905){var e = e14905;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_patient_name = (function react_med$screens$patient_info$core$change_patient_name(app_state,p__14906){
var vec__14907 = p__14906;
var event = cljs.core.nth.call(null,vec__14907,(0),null);
var new_name = cljs.core.nth.call(null,vec__14907,(1),null);
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.screens.patient_info.core.change_birth_date = (function react_med$screens$patient_info$core$change_birth_date(app_state,p__14910){
var vec__14911 = p__14910;
var event = cljs.core.nth.call(null,vec__14911,(0),null);
var new_birth_date = cljs.core.nth.call(null,vec__14911,(1),null);
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
return result__14245__auto__;
}catch (e14914){var e = e14914;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_birth_date = (function react_med$screens$patient_info$core$change_birth_date(app_state,p__14915){
var vec__14916 = p__14915;
var event = cljs.core.nth.call(null,vec__14916,(0),null);
var new_birth_date = cljs.core.nth.call(null,vec__14916,(1),null);
...
var result__14245__auto__ = p1__14919_SHARP_;
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"p1__14919#","p1__14919#",-1571639959,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(4)], null));

return result__14245__auto__;
})(),"Feminino");
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__14919#","p1__14919#",-1571639959,null),"Feminino"),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(3)], null));

return result__14245__auto__;
})())?"Masculino":"Feminino");
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__14919#","p1__14919#",-1571639959,null),"Feminino"),"Masculino","Feminino"),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(2)], null));

return result__14245__auto__;
});})(opts__14244__auto____$1,opts__14244__auto__,_PLUS_debux_dbg_opts_PLUS_))
;
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__14919#","p1__14919#",-1571639959,null)], null),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__14919#","p1__14919#",-1571639959,null),"Feminino"),"Masculino","Feminino")),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__14245__auto__;
})());
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"update-in","update-in",-1445516941,null),new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"domain","domain",1847214937),new cljs.core.Keyword(null,"patients","patients",134252075),(0),new cljs.core.Keyword(null,"sexo","sexo",-629407757)], null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__14919#","p1__14919#",-1571639959,null)], null),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__14919#","p1__14919#",-1571639959,null),"Feminino"),"Masculino","Feminino"))),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(0)], null));
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.screens.patient_info.core.change_height = (function react_med$screens$patient_info$core$change_height(app_state,p__14921){
var vec__14922 = p__14921;
var event = cljs.core.nth.call(null,vec__14922,(0),null);
var new_height = cljs.core.nth.call(null,vec__14922,(1),null);
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
return result__14245__auto__;
}catch (e14925){var e = e14925;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_height = (function react_med$screens$patient_info$core$change_height(app_state,p__14926){
var vec__14927 = p__14926;
var event = cljs.core.nth.call(null,vec__14927,(0),null);
var new_height = cljs.core.nth.call(null,vec__14927,(1),null);
...
var vec__14930 = cljs.core.re_find.call(null,/(\d{1,2})\D(\d{1,2})\D(\d{4})/,text);
var _ = cljs.core.nth.call(null,vec__14930,(0),null);
var d = cljs.core.nth.call(null,vec__14930,(1),null);
var m = cljs.core.nth.call(null,vec__14930,(2),null);
var y = cljs.core.nth.call(null,vec__14930,(3),null);
...
var map__14936 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.patient-info.core","selected-patient","react-med.screens.patient-info.core/selected-patient",-1719364628)], null));
...
var map__14938 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.patient-info.core","selected-patient","react-med.screens.patient-info.core/selected-patient",-1719364628)], null));
...
var nome = cljs.core.get.call(null,map__14938__$1,new cljs.core.Keyword(null,"nome","nome",1100401122));
var nascimento = cljs.core.get.call(null,map__14938__$1,new cljs.core.Keyword(null,"nascimento","nascimento",646565528));
var idade = cljs.core.get.call(null,map__14938__$1,new cljs.core.Keyword(null,"idade","idade",297389078));
var sexo = cljs.core.get.call(null,map__14938__$1,new cljs.core.Keyword(null,"sexo","sexo",-629407757));
var estatura = cljs.core.get.call(null,map__14938__$1,new cljs.core.Keyword(null,"estatura","estatura",-685084760));
...
react_med.screens.patient_info.core.patient_detail = (function react_med$screens$patient_info$core$patient_detail(p__14940,content_view){
...
var actions = cljs.core.get.call(null,map__14941__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
