...
react_med.authentication.authentication.login_error = (function react_med$authentication$authentication$login_error(app_state,p__19328){
var vec__19329 = p__19328;
var event = cljs.core.nth.call(null,vec__19329,(0),null);
var attr = cljs.core.nth.call(null,vec__19329,(1),null);
var message = cljs.core.nth.call(null,vec__19329,(2),null);
...
}catch (e19332){var e = e19332;
throw e;
}});
} else {
react_med.authentication.authentication.login_error = (function react_med$authentication$authentication$login_error(app_state,p__19333){
var vec__19334 = p__19333;
var event = cljs.core.nth.call(null,vec__19334,(0),null);
var attr = cljs.core.nth.call(null,vec__19334,(1),null);
var message = cljs.core.nth.call(null,vec__19334,(2),null);
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.authentication.authentication.email_and_password_login = (function react_med$authentication$authentication$email_and_password_login(p__19339,_){
...
var _PLUS_debux_dbg_opts_PLUS__19347 = cljs.core.PersistentArrayMap.EMPTY;
...
var opts__19139__auto___19348 = _PLUS_debux_dbg_opts_PLUS__19347;
var result__19140__auto___19349 = console.log("Logando",(function (){var opts__19139__auto____$1 = _PLUS_debux_dbg_opts_PLUS__19347;
var result__19140__auto__ = react_med.authentication.authentication.sign_in_with_email_and_password.call(null,(function (){var opts__19139__auto____$2 = _PLUS_debux_dbg_opts_PLUS__19347;
var result__19140__auto__ = cljs.core.get_in.call(null,(function (){var opts__19139__auto____$3 = _PLUS_debux_dbg_opts_PLUS__19347;
...
return result__19140__auto__;
})(),(function (){var opts__19139__auto____$3 = _PLUS_debux_dbg_opts_PLUS__19347;
...
return result__19140__auto__;
})(),(function (){var opts__19139__auto____$2 = _PLUS_debux_dbg_opts_PLUS__19347;
var result__19140__auto__ = cljs.core.get_in.call(null,(function (){var opts__19139__auto____$3 = _PLUS_debux_dbg_opts_PLUS__19347;
var result__19140__auto__ = db;
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__19140__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"db","db",-1661185010,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(3)], null));
...
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__19140__auto___19349,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol("js","console.log","js/console.log",-2005248266,null),"Logando",cljs.core.list(new cljs.core.Symbol(null,"sign-in-with-email-and-password","sign-in-with-email-and-password",1447802044,null),cljs.core.list(new cljs.core.Symbol(null,"get-in","get-in",-1965644065,null),new cljs.core.Symbol(null,"db","db",-1661185010,null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ui","ui",-469653645),new cljs.core.Keyword(null,"login","login",55217519),new cljs.core.Keyword(null,"email","email",1415816706)], null)),cljs.core.list(new cljs.core.Symbol(null,"get-in","get-in",-1965644065,null),new cljs.core.Symbol(null,"db","db",-1661185010,null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ui","ui",-469653645),new cljs.core.Keyword(null,"login","login",55217519),new cljs.core.Keyword(null,"password","password",417022471)], null)))),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(0)], null));

}catch (e19342){var e_19350 = e19342;
throw e_19350;
}
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
return result__19140__auto__;
}catch (e19343){var e = e19343;
throw e;
}});
} else {
react_med.authentication.authentication.email_and_password_login = (function react_med$authentication$authentication$email_and_password_login(p__19344,_){
var map__19345 = p__19344;
var map__19345__$1 = (((((!((map__19345 == null))))?(((((map__19345.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19345.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19345):map__19345);
var db = cljs.core.get.call(null,map__19345__$1,new cljs.core.Keyword(null,"db","db",993250759));
var store = cljs.core.get.call(null,map__19345__$1,new cljs.core.Keyword(null,"store","store",1512230022));
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.authentication.authentication.user_logged_in = (function react_med$authentication$authentication$user_logged_in(p__19351,p__19352){
var map__19353 = p__19351;
var map__19353__$1 = (((((!((map__19353 == null))))?(((((map__19353.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19353.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19353):map__19353);
var db = cljs.core.get.call(null,map__19353__$1,new cljs.core.Keyword(null,"db","db",993250759));
var store = cljs.core.get.call(null,map__19353__$1,new cljs.core.Keyword(null,"store","store",1512230022));
var vec__19354 = p__19352;
var event = cljs.core.nth.call(null,vec__19354,(0),null);
var email = cljs.core.nth.call(null,vec__19354,(1),null);
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
try{debux.common.util.send_form_BANG_.call(null,cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"not=","not=",1466536204,null),new cljs.core.Symbol(null,"email","email",-1238619063,null),cljs.core.list(new cljs.core.Symbol(null,"get-in","get-in",-1965644065,null),new cljs.core.Symbol(null,"store","store",-1142205747,null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"authentication","authentication",1746273042),new cljs.core.Keyword(null,"user-email","user-email",2126479881)], null))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"store","store",1512230022),null,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.storage-module.firebase","restore-domain-from-firebase","react-med.storage-module.firebase/restore-domain-from-firebase",558704003)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.storage-module.local-storage","load-domain-from-local-storage","react-med.storage-module.local-storage/load-domain-from-local-storage",-1642872826)], null)], null)));
...
var result__19140__auto__ = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"store","store",1512230022),null,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.storage-module.firebase","restore-domain-from-firebase","react-med.storage-module.firebase/restore-domain-from-firebase",558704003)], null)], null);
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__19140__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"store","store",1512230022),null,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.storage-module.firebase","restore-domain-from-firebase","react-med.storage-module.firebase/restore-domain-from-firebase",558704003)], null)], null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__19140__auto__;
})():(function (){var opts__19139__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__19140__auto__ = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.storage-module.local-storage","load-domain-from-local-storage","react-med.storage-module.local-storage/load-domain-from-local-storage",-1642872826)], null)], null);
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__19140__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.storage-module.local-storage","load-domain-from-local-storage","react-med.storage-module.local-storage/load-domain-from-local-storage",-1642872826)], null)], null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));
...
return result__19140__auto__;
}catch (e19358){var e = e19358;
throw e;
}});
} else {
react_med.authentication.authentication.user_logged_in = (function react_med$authentication$authentication$user_logged_in(p__19359,p__19360){
var map__19361 = p__19359;
...
var db = cljs.core.get.call(null,map__19361__$1,new cljs.core.Keyword(null,"db","db",993250759));
var store = cljs.core.get.call(null,map__19361__$1,new cljs.core.Keyword(null,"store","store",1512230022));
var vec__19362 = p__19360;
var event = cljs.core.nth.call(null,vec__19362,(0),null);
var email = cljs.core.nth.call(null,vec__19362,(1),null);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"store","store",1512230022),null,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.storage-module.firebase","restore-domain-from-firebase","react-med.storage-module.firebase/restore-domain-from-firebase",558704003)], null)], null);
} else {
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.storage-module.local-storage","load-domain-from-local-storage","react-med.storage-module.local-storage/load-domain-from-local-storage",-1642872826)], null)], null);
}
});
}
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.authentication.authentication.user_logged_out = (function react_med$authentication$authentication$user_logged_out(p__19366,_){
...
var db = cljs.core.get.call(null,map__19367__$1,new cljs.core.Keyword(null,"db","db",993250759));
var store = cljs.core.get.call(null,map__19367__$1,new cljs.core.Keyword(null,"store","store",1512230022));
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
return result__19140__auto__;
}catch (e19369){var e = e19369;
throw e;
}});
} else {
react_med.authentication.authentication.user_logged_out = (function react_med$authentication$authentication$user_logged_out(p__19370,_){
