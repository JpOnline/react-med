...
var G__20080 = navigator;
var G__20080__$1 = (((G__20080 == null))?null:G__20080.serviceWorker);
if((G__20080__$1 == null)){
return null;
} else {
return G__20080__$1.register("/sw.js");
}
}));
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("react-med.main","initialize-app-state","react-med.main/initialize-app-state",286610468),((day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null))?(function (_,p__20081){
var vec__20082 = p__20081;
var event = cljs.core.nth.call(null,vec__20082,(0),null);
var application_state = cljs.core.nth.call(null,vec__20082,(1),null);
...
var event = cljs.core.nth.call(null,vec__20087,(0),null);
var application_state = cljs.core.nth.call(null,vec__20087,(1),null);
