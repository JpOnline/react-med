...
var G__20758 = navigator;
var G__20758__$1 = (((G__20758 == null))?null:G__20758.serviceWorker);
if((G__20758__$1 == null)){
return null;
} else {
return G__20758__$1.register("/react-med/sw.js");
}
}));
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("react-med.main","initialize-app-state","react-med.main/initialize-app-state",286610468),((day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null))?(function (_,p__20759){
var vec__20760 = p__20759;
var event = cljs.core.nth.call(null,vec__20760,(0),null);
var application_state = cljs.core.nth.call(null,vec__20760,(1),null);
...
var vec__20765 = p__20764;
var event = cljs.core.nth.call(null,vec__20765,(0),null);
var application_state = cljs.core.nth.call(null,vec__20765,(1),null);
