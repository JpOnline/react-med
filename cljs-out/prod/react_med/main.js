...
var G__20742 = navigator;
var G__20742__$1 = (((G__20742 == null))?null:G__20742.serviceWorker);
if((G__20742__$1 == null)){
return null;
} else {
return G__20742__$1.register("/react-med/sw.js");
}
}));
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("react-med.main","initialize-app-state","react-med.main/initialize-app-state",286610468),((day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null))?(function (_,p__20743){
var vec__20744 = p__20743;
var event = cljs.core.nth.call(null,vec__20744,(0),null);
var application_state = cljs.core.nth.call(null,vec__20744,(1),null);
...
var result__14483__auto__ = application_state;
...
}catch (e20747){var e = e20747;
throw e;
}}):(function (_,p__20748){
var vec__20749 = p__20748;
var event = cljs.core.nth.call(null,vec__20749,(0),null);
var application_state = cljs.core.nth.call(null,vec__20749,(1),null);
