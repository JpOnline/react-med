...
var G__20060 = navigator;
var G__20060__$1 = (((G__20060 == null))?null:G__20060.serviceWorker);
if((G__20060__$1 == null)){
return null;
} else {
return G__20060__$1.register("/sw.js");
}
}));
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("react-med.main","initialize-app-state","react-med.main/initialize-app-state",286610468),((day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null))?(function (_,p__20061){
var vec__20062 = p__20061;
var event = cljs.core.nth.call(null,vec__20062,(0),null);
var application_state = cljs.core.nth.call(null,vec__20062,(1),null);
...
var event = cljs.core.nth.call(null,vec__20067,(0),null);
var application_state = cljs.core.nth.call(null,vec__20067,(1),null);
