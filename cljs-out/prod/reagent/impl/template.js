...
var G__12866_12869 = reagent.impl.template.prop_name_cache;
var G__12867_12870 = cljs.core.name(k);
var G__12868_12871 = v;
goog.object.set(G__12866_12869,G__12867_12870,G__12868_12871);
...
var G__12872 = o;
var G__12873_12876 = G__12872;
var G__12874_12877 = reagent.impl.template.cached_prop_name(k);
var G__12875_12878 = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v));
goog.object.set(G__12873_12876,G__12874_12877,G__12875_12878);
...
return (function() { 
var G__12879__delegate = function (args){
...
while (G__12880__i < G__12880__a.length) {G__12880__a[G__12880__i] = arguments[G__12880__i + 0]; ++G__12880__i;}
  args = new cljs.core.IndexedSeq(G__12880__a,0,null);
} 
return G__12879__delegate.call(this,args);};
G__12879.cljs$lang$maxFixedArity = 0;
G__12879.cljs$lang$applyTo = (function (arglist__12881){
var args = cljs.core.seq(arglist__12881);
return G__12879__delegate(args);
});
...
if((temp__5737__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
var G__12882_12885 = reagent.impl.template.custom_prop_name_cache;
var G__12883_12886 = cljs.core.name(k);
var G__12884_12887 = v;
goog.object.set(G__12882_12885,G__12883_12886,G__12884_12887);
...
var G__12888 = o;
var G__12889_12892 = G__12888;
var G__12890_12893 = reagent.impl.template.cached_custom_prop_name(k);
var G__12891_12894 = reagent.impl.template.convert_prop_value(v);
goog.object.set(G__12889_12892,G__12890_12893,G__12891_12894);
...
while (G__12896__i < G__12896__a.length) {G__12896__a[G__12896__i] = arguments[G__12896__i + 0]; ++G__12896__i;}
  args = new cljs.core.IndexedSeq(G__12896__a,0,null);
} 
...
var G__12898 = props;
var G__12898__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12898,cljs.core.cst$kw$id,id):G__12898);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12898__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__12898__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12899 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12899,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12899;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12900){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12901__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__12901,map__12901__$1,on_write){
return (function (){
...
});})(node_value,map__12901,map__12901__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change(this$,on_change,p1__12903_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__12906 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12906,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12906,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12906,(2),null);
...
var temp__5739__auto___12910 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___12910 == null)){
} else {
var key_12911 = temp__5739__auto___12910;
jsprops.key = key_12911;
}
...
var temp__5739__auto___12912 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___12912 == null)){
} else {
var key_12913 = temp__5739__auto___12912;
jsprops.key = key_12913;
}
...
var G__12914 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12914) : reagent.impl.template.as_element.call(null,G__12914));
} else {
var temp__5739__auto___12915 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___12915 == null)){
} else {
var key_12916 = temp__5739__auto___12915;
jsprops.key = key_12916;
}
...
var G__12918 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__12918)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__12918)){
return x;
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12919){
var G__12920 = cljs.core.first(seq12919);
var seq12919__$1 = cljs.core.next(seq12919);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12920,seq12919__$1);
});
...
break;
default:
var G__12926 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__12926;
continue;
...
var ctx = ({});
var vec__12928 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12928,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12928,(1),null);
...
var G__12931 = (cljs.core.count(argv) - first_child);
switch (G__12931) {
case (0):
...
break;
case (1):
var G__12932 = component;
var G__12933 = jsprops;
var G__12934 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__12932,G__12933,G__12934) : reagent.impl.template.global$module$react.createElement.call(null,G__12932,G__12933,G__12934));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__12931){
