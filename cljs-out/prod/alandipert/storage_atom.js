...
return m__4434__auto__.call(null,this$,not_found);
} else {
var m__4431__auto__ = (alandipert.storage_atom._get["_"]);
if((!((m__4431__auto__ == null)))){
return m__4431__auto__.call(null,this$,not_found);
} else {
...
var self__ = this;
var this$__$1 = this;
var temp__5733__auto__ = self__.store.getItem(alandipert.storage_atom.clj__GT_json.call(null,self__.key));
...
return cljs.core._write.call(null,writer__4375__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__10814 = atom;
cljs.core.add_watch.call(null,G__10814,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__10814,existing,debounce){
return (function (p1__10812_SHARP_,p2__10813_SHARP_,p3__10810_SHARP_,p4__10811_SHARP_){
if(((alandipert.storage_atom._STAR_watch_active_STAR_) && (cljs.core.not_EQ_.call(null,p3__10810_SHARP_,p4__10811_SHARP_)))){
return debounce.call(null,((function (G__10814,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__10811_SHARP_);
});})(G__10814,existing,debounce))
,(function (){var or__4131__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR__orig_val__10815 = alandipert.storage_atom._STAR_watch_active_STAR_;
var _STAR_watch_active_STAR__temp_val__10816 = false;
alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__temp_val__10816;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__orig_val__10815;
}} else {
try{var temp__5735__auto__ = alandipert.storage_atom.json__GT_clj.call(null,e.key);
if(cljs.core.truth_(temp__5735__auto__)){
var sk = temp__5735__auto__;
if(cljs.core._EQ_.call(null,sk,k)){
var _STAR_watch_active_STAR__orig_val__10818 = alandipert.storage_atom._STAR_watch_active_STAR_;
var _STAR_watch_active_STAR__temp_val__10819 = false;
alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__temp_val__10819;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__orig_val__10818;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__10820_SHARP_);
});})(default$))
);
});
/**
