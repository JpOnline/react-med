...
return tick.format.formatter.call(null,fmt,(function (){try{var G__14853 = goog.object.get(JSJodaLocale,"Locale");
if((G__14853 == null)){
return null;
} else {
return goog.object.get(G__14853,"US");
}
}catch (e14852){if((e14852 instanceof Error)){
var e = e14852;
return null;
} else {
throw e14852;
