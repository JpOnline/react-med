...
return cljs.core.reduce.call(null,(function (result,p__15511){
...
var vec__15515 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__15515,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__15515,(1),null);
var ab = cljs.core.nth.call(null,vec__15515,(2),null);
...
return (function (){var G__15524 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15524__$1)].join('')));
