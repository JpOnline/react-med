...
var G__15723 = clojure.zip.node(loc);
var fexpr__15722 = cljs.core.cst$kw$zip_SLASH_branch_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__15722.cljs$core$IFn$_invoke$arity$1 ? fexpr__15722.cljs$core$IFn$_invoke$arity$1(G__15723) : fexpr__15722.call(null,G__15723));
});
/**
...
var G__15725 = clojure.zip.node(loc);
var fexpr__15724 = cljs.core.cst$kw$zip_SLASH_children.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__15724.cljs$core$IFn$_invoke$arity$1 ? fexpr__15724.cljs$core$IFn$_invoke$arity$1(G__15725) : fexpr__15724.call(null,G__15725));
} else {
...
var fexpr__15726 = cljs.core.cst$kw$zip_SLASH_make_DASH_node.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__15726.cljs$core$IFn$_invoke$arity$2 ? fexpr__15726.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__15726.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__15727 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15727,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15727,(1),null);
var vec__15730 = clojure.zip.children(loc);
...
var vec__15733 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15733,(0),null);
var map__15736 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15733,(1),null);
...
var path = map__15736__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15736__$1,cljs.core.cst$kw$l);
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15736__$1,cljs.core.cst$kw$ppath);
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15736__$1,cljs.core.cst$kw$pnodes);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15736__$1,cljs.core.cst$kw$r);
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15736__$1,cljs.core.cst$kw$changed_QMARK_);
...
var map__15742 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15739,(1),null);
...
var path = map__15742__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15742__$1,cljs.core.cst$kw$l);
var vec__15743 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15742__$1,cljs.core.cst$kw$r);
...
var vec__15747 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15747,(0),null);
var map__15750 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15747,(1),null);
...
var path = map__15750__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15750__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15750__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__4120__auto__ = path;
if(cljs.core.truth_(and__4120__auto__)){
return r;
} else {
...
var vec__15752 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15752,(0),null);
var map__15755 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15752,(1),null);
...
var path = map__15755__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15755__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15755__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__4120__auto__ = path;
if(cljs.core.truth_(and__4120__auto__)){
...
var vec__15757 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15757,(0),null);
var map__15760 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15757,(1),null);
...
var path = map__15760__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15760__$1,cljs.core.cst$kw$l);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15760__$1,cljs.core.cst$kw$r);
if(cljs.core.truth_((function (){var and__4120__auto__ = path;
if(cljs.core.truth_(and__4120__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__15762 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15762,(0),null);
var map__15765 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15762,(1),null);
var map__15765__$1 = (((((!((map__15765 == null))))?(((((map__15765.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15765.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15765):map__15765);
var path = map__15765__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15765__$1,cljs.core.cst$kw$l);
if((path == null)){
throw "Insert at top";
} else {
...
var vec__15767 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15767,(0),null);
var map__15770 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15767,(1),null);
var map__15770__$1 = (((((!((map__15770 == null))))?(((((map__15770.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15770.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15770):map__15770);
var path = map__15770__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15770__$1,cljs.core.cst$kw$r);
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15772,(1),null);
...
var len__4730__auto___15778 = arguments.length;
var i__4731__auto___15779 = (0);
while(true){
if((i__4731__auto___15779 < len__4730__auto___15778)){
args__4736__auto__.push((arguments[i__4731__auto___15779]));

var G__15780 = (i__4731__auto___15779 + (1));
i__4731__auto___15779 = G__15780;
continue;
} else {
}
break;
...
/** @this {Function} */
clojure.zip.edit.cljs$lang$applyTo = (function (seq15775){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15776,G__15777,seq15775__$2);
});
...
var G__15782 = clojure.zip.rightmost(child);
loc__$1 = G__15782;
continue;
} else {
return loc__$1;
...
var vec__15783 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15783,(0),null);
var map__15786 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15783,(1),null);
var map__15786__$1 = (((((!((map__15786 == null))))?(((((map__15786.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15786.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15786):map__15786);
var path = map__15786__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15786__$1,cljs.core.cst$kw$l);
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15786__$1,cljs.core.cst$kw$ppath);
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15786__$1,cljs.core.cst$kw$pnodes);
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15786__$1,cljs.core.cst$kw$r);
if((path == null)){
throw "Remove at top";
} else {
...
var G__15788 = clojure.zip.rightmost(child);
loc__$1 = G__15788;
continue;
} else {
return loc__$1;
