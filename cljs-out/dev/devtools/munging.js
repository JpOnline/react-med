...
var o22955 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22955["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22956 = temp__5733__auto____$1;
return (o22956["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22065__auto__ = f;
return (o__22065__auto__["toString"]).call(o__22065__auto__);
} else {
return "";
}
}catch (e22957){var _ = e22957;
return "";
}});
...
try{var o__22065__auto___22959 = t;
(o__22065__auto___22959["cljs$lang$ctorPrWriter"]).call(o__22065__auto___22959,t,writer);
}catch (e22958){var __22960 = e22958;
}
...
var char_code = (function (){var o__22065__auto__ = (new String(char$));
return (o__22065__auto__["charCodeAt"]).call(o__22065__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22065__auto__ = String;
return (o__22065__auto__["fromCharCode"]).call(o__22065__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22961 = num_code;
switch (G__22961) {
case (1):
return (185);
...
var o__22065__auto__ = String;
return (o__22065__auto__["fromCharCode"]).call(o__22065__auto__,superscript_code);
});
/**
...
}catch (e22963){var _e__22072__auto__ = e22963;
return false;
}})())){
...
var vec__22964 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22964,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o22967 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22967["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22968 = temp__5733__auto____$1;
return (o22968["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___22975 = arguments.length;
var i__4731__auto___22976 = (0);
while(true){
if((i__4731__auto___22976 < len__4730__auto___22975)){
args__4736__auto__.push((arguments[i__4731__auto___22976]));

var G__22977 = (i__4731__auto___22976 + (1));
i__4731__auto___22976 = G__22977;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22971){
var vec__22972 = p__22971;
var ns_detector = cljs.core.nth.call(null,vec__22972,(0),null);
...
var G__22978 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22979 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22978;
remaining_tokens = G__22979;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22969){
var G__22970 = cljs.core.first.call(null,seq22969);
var seq22969__$1 = cljs.core.next.call(null,seq22969);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22970,seq22969__$1);
});
...
var vec__22983 = cljs.core.split_with.call(null,(function (p1__22982_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22982_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22983,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22983,(1),null);
...
var vec__22989 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22989,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22989,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22992 = cljs.core.rest.call(null,remaining_tokens);
var G__22993 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22992;
name_tokens = G__22993;
continue;
} else {
...
var vec__22996 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22996,(0),null);
var arity = cljs.core.nth.call(null,vec__22996,(1),null);
var vec__22999 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22999,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22999,(1),null);
var vec__23002 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23002,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23002,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23002,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23002,(3),null);
...
var vec__23008 = result;
var munged_ns = cljs.core.nth.call(null,vec__23008,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23008,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23008,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23008,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23008,(4),null);
var arity = cljs.core.nth.call(null,vec__23008,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__23012 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__23012,(0),null);
var args = cljs.core.nth.call(null,vec__23012,(1),null);
var vec__23015 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23015,(0),null);
var name = cljs.core.nth.call(null,vec__23015,(1),null);
...
var G__23018 = (arity + (1));
var G__23019 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23020){
var vec__23021 = p__23020;
var arity = cljs.core.nth.call(null,vec__23021,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23021,(1),null);
...
return (function (p1__23024_SHARP_){
return cljs.core.get.call(null,arities,p1__23024_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23025_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23028){
var vec__23029 = p__23028;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23029,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23026){
var G__23027 = cljs.core.first.call(null,seq23026);
var seq23026__$1 = cljs.core.next.call(null,seq23026);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23027,seq23026__$1);
});
...
var G__23035 = arg;
var G__23035__$1 = (((G__23035 instanceof cljs.core.Keyword))?G__23035.fqn:null);
switch (G__23035__$1) {
...
var map__23037 = options;
var map__23037__$1 = (((((!((map__23037 == null))))?(((((map__23037.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23037.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23037):map__23037);
var include_ns_QMARK_ = cljs.core.get.call(null,map__23037__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23037__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23037__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23037__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23038 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23038,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23038,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23038,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23038,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23038,(4),null);
var arity = cljs.core.nth.call(null,vec__23038,(5),null);
...
var o__22065__auto__ = f;
return (o__22065__auto__["getBasis"]).call(o__22065__auto__);
});
/**
...
}catch (e23042){var _e__22072__auto__ = e23042;
...
var G__23043 = (obj[cljs.core.first.call(null,path)]);
var G__23044 = cljs.core.rest.call(null,path);
obj = G__23043;
path = G__23044;
continue;
} else {
...
return (function (accum,p__23045){
var vec__23046 = p__23045;
var bit = cljs.core.nth.call(null,vec__23046,(0),null);
var protocol = cljs.core.nth.call(null,vec__23046,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23049){
var vec__23050 = p__23049;
var ns = cljs.core.nth.call(null,vec__23050,(0),null);
var name = cljs.core.nth.call(null,vec__23050,(1),null);
var selector = cljs.core.nth.call(null,vec__23050,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23055,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23055,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23055,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23053_SHARP_){
return (obj[cljs.core.first.call(null,p1__23053_SHARP_)]);
});})(name,sorted_matches,vec__23055,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
