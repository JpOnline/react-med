...
var G__23060 = devtools.prefs.pref.call(null,v);
v = G__23060;
continue;
} else {
return v;
...
}catch (e23063){var _e__22072__auto__ = e23063;
return false;
}})();
...
}catch (e23067){var _e__22072__auto__ = e23067;
return false;
}})();
...
}catch (e23069){var _e__22072__auto__ = e23069;
return false;
}}
}
});
...
var vec__23071 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__23071,(0),null);
var name = cljs.core.nth.call(null,vec__23071,(1),null);
...
return cljs.core.some.call(null,(function (p1__23074_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__23074_SHARP_);
}),template);
});
