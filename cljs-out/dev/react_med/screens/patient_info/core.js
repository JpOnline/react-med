...
return navigator.share(({"files": [(new Blob([data],"Avaliacao.csv"))], "title": "Avalia\u00E7\u00E3o da Dani", "text": "Texto q acho q n\u00E3o vai aparecer."})).then((function (){
return console.log("Conseguiu compartilhar.");
})).catch((function (p1__35131_SHARP_){
return console.log("N\u00E3o conseguiu compartilhar.",p1__35131_SHARP_);
}));
});
...
var vec__35132 = cljs.core.re_find.call(null,/(\d{4})\D(\d{1,2})\D(\d{1,2})/,date);
var _ = cljs.core.nth.call(null,vec__35132,(0),null);
var year = cljs.core.nth.call(null,vec__35132,(1),null);
var month = cljs.core.nth.call(null,vec__35132,(2),null);
var day = cljs.core.nth.call(null,vec__35132,(3),null);
...
react_med.screens.patient_info.core.export_to_csv = (function react_med$screens$patient_info$core$export_to_csv(app_state,p__35135){
var vec__35136 = p__35135;
var event = cljs.core.nth.call(null,vec__35136,(0),null);
...
var map__35139_35141 = react_med.screens.patient_info.core.selected_patient.call(null,app_state);
var map__35139_35142__$1 = (((((!((map__35139_35141 == null))))?(((((map__35139_35141.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__35139_35141.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__35139_35141):map__35139_35141);
var nome_35143 = cljs.core.get.call(null,map__35139_35142__$1,new cljs.core.Keyword(null,"nome","nome",1100401122));
var nascimento_35144 = cljs.core.get.call(null,map__35139_35142__$1,new cljs.core.Keyword(null,"nascimento","nascimento",646565528));
var sexo_35145 = cljs.core.get.call(null,map__35139_35142__$1,new cljs.core.Keyword(null,"sexo","sexo",-629407757));
var estatura_35146 = cljs.core.get.call(null,map__35139_35142__$1,new cljs.core.Keyword(null,"estatura","estatura",-685084760));
var csv_data_35147 = testdouble.cljs.csv.write_csv.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Nome",nome_35143], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Data de Nascimento",react_med.screens.patient_info.core.yyyy_mm_dd__GT_dd_mm_yyyy.call(null,nascimento_35144)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Sexo",sexo_35145], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Estatura",cljs.core.str.cljs$core$IFn$_invoke$arity$1(estatura_35146).replace(".",",")], null)], null),new cljs.core.Keyword(null,"quote?","quote?",-1114029317),true);
console.log("csv\n",csv_data_35147);

react_med.screens.patient_info.core.share.call(null,csv_data_35147,"teste.csv","text/csv");
...
react_med.screens.patient_info.core.change_patient_name = (function react_med$screens$patient_info$core$change_patient_name(app_state,p__35148){
var vec__35149 = p__35148;
var event = cljs.core.nth.call(null,vec__35149,(0),null);
var new_name = cljs.core.nth.call(null,vec__35149,(1),null);
...
return result__14245__auto__;
}catch (e35152){var e = e35152;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_patient_name = (function react_med$screens$patient_info$core$change_patient_name(app_state,p__35153){
var vec__35154 = p__35153;
var event = cljs.core.nth.call(null,vec__35154,(0),null);
var new_name = cljs.core.nth.call(null,vec__35154,(1),null);
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.screens.patient_info.core.change_birth_date = (function react_med$screens$patient_info$core$change_birth_date(app_state,p__35157){
var vec__35158 = p__35157;
var event = cljs.core.nth.call(null,vec__35158,(0),null);
var new_birth_date = cljs.core.nth.call(null,vec__35158,(1),null);
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
return result__14245__auto__;
}catch (e35161){var e = e35161;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_birth_date = (function react_med$screens$patient_info$core$change_birth_date(app_state,p__35162){
var vec__35163 = p__35162;
var event = cljs.core.nth.call(null,vec__35163,(0),null);
var new_birth_date = cljs.core.nth.call(null,vec__35163,(1),null);
...
var result__14245__auto__ = p1__35166_SHARP_;
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"p1__35166#","p1__35166#",-2083703084,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(4)], null));

return result__14245__auto__;
})(),"Feminino");
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__35166#","p1__35166#",-2083703084,null),"Feminino"),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(3)], null));

return result__14245__auto__;
})())?"Masculino":"Feminino");
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__35166#","p1__35166#",-2083703084,null),"Feminino"),"Masculino","Feminino"),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(2)], null));

return result__14245__auto__;
});})(opts__14244__auto____$1,opts__14244__auto__,_PLUS_debux_dbg_opts_PLUS_))
;
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__35166#","p1__35166#",-2083703084,null)], null),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__35166#","p1__35166#",-2083703084,null),"Feminino"),"Masculino","Feminino")),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__14245__auto__;
})());
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"update-in","update-in",-1445516941,null),new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"domain","domain",1847214937),new cljs.core.Keyword(null,"patients","patients",134252075),(0),new cljs.core.Keyword(null,"sexo","sexo",-629407757)], null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__35166#","p1__35166#",-2083703084,null)], null),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__35166#","p1__35166#",-2083703084,null),"Feminino"),"Masculino","Feminino"))),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(0)], null));

return result__14245__auto__;
}catch (e35167){var e = e35167;
throw e;
}});
} else {
react_med.screens.patient_info.core.toggle_sexo = (function react_med$screens$patient_info$core$toggle_sexo(app_state){
return cljs.core.update_in.call(null,app_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"domain","domain",1847214937),new cljs.core.Keyword(null,"patients","patients",134252075),(0),new cljs.core.Keyword(null,"sexo","sexo",-629407757)], null),(function (p1__35166_SHARP_){
if(cljs.core._EQ_.call(null,p1__35166_SHARP_,"Feminino")){
return "Masculino";
} else {
return "Feminino";
}
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.screens.patient_info.core.change_height = (function react_med$screens$patient_info$core$change_height(app_state,p__35168){
var vec__35169 = p__35168;
var event = cljs.core.nth.call(null,vec__35169,(0),null);
var new_height = cljs.core.nth.call(null,vec__35169,(1),null);
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
react_med.screens.patient_info.core.change_height = (function react_med$screens$patient_info$core$change_height(app_state,p__35173){
var vec__35174 = p__35173;
var event = cljs.core.nth.call(null,vec__35174,(0),null);
var new_height = cljs.core.nth.call(null,vec__35174,(1),null);
...
var vec__35177 = cljs.core.re_find.call(null,/(\d{1,2})\D(\d{1,2})\D(\d{4})/,text);
var _ = cljs.core.nth.call(null,vec__35177,(0),null);
var d = cljs.core.nth.call(null,vec__35177,(1),null);
var m = cljs.core.nth.call(null,vec__35177,(2),null);
var y = cljs.core.nth.call(null,vec__35177,(3),null);
...
var map__35183 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.patient-info.core","selected-patient","react-med.screens.patient-info.core/selected-patient",-1719364628)], null));
...
var map__35185 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.patient-info.core","selected-patient","react-med.screens.patient-info.core/selected-patient",-1719364628)], null));
...
var nome = cljs.core.get.call(null,map__35185__$1,new cljs.core.Keyword(null,"nome","nome",1100401122));
var nascimento = cljs.core.get.call(null,map__35185__$1,new cljs.core.Keyword(null,"nascimento","nascimento",646565528));
var idade = cljs.core.get.call(null,map__35185__$1,new cljs.core.Keyword(null,"idade","idade",297389078));
var sexo = cljs.core.get.call(null,map__35185__$1,new cljs.core.Keyword(null,"sexo","sexo",-629407757));
var estatura = cljs.core.get.call(null,map__35185__$1,new cljs.core.Keyword(null,"estatura","estatura",-685084760));
...
react_med.screens.patient_info.core.patient_detail = (function react_med$screens$patient_info$core$patient_detail(p__35187,content_view){
...
var actions = cljs.core.get.call(null,map__35188__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
