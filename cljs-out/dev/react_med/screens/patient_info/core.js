...
return navigator.share(({"files": [(new File([data],"Avaliacao.csv",({"type": type})))], "title": "Avalia\u00E7\u00E3o da Dani", "text": "Texto q acho q n\u00E3o vai aparecer."})).then((function (){
return console.log("Conseguiu compartilhar.");
})).catch((function (p1__36117_SHARP_){
return console.log("N\u00E3o conseguiu compartilhar.",p1__36117_SHARP_);
}));
});
...
var vec__36118 = cljs.core.re_find.call(null,/(\d{4})\D(\d{1,2})\D(\d{1,2})/,date);
var _ = cljs.core.nth.call(null,vec__36118,(0),null);
var year = cljs.core.nth.call(null,vec__36118,(1),null);
var month = cljs.core.nth.call(null,vec__36118,(2),null);
var day = cljs.core.nth.call(null,vec__36118,(3),null);
...
react_med.screens.patient_info.core.export_to_csv = (function react_med$screens$patient_info$core$export_to_csv(app_state,p__36121){
var vec__36122 = p__36121;
var event = cljs.core.nth.call(null,vec__36122,(0),null);
...
var map__36125_36127 = react_med.screens.patient_info.core.selected_patient.call(null,app_state);
var map__36125_36128__$1 = (((((!((map__36125_36127 == null))))?(((((map__36125_36127.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36125_36127.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36125_36127):map__36125_36127);
var nome_36129 = cljs.core.get.call(null,map__36125_36128__$1,new cljs.core.Keyword(null,"nome","nome",1100401122));
var nascimento_36130 = cljs.core.get.call(null,map__36125_36128__$1,new cljs.core.Keyword(null,"nascimento","nascimento",646565528));
var sexo_36131 = cljs.core.get.call(null,map__36125_36128__$1,new cljs.core.Keyword(null,"sexo","sexo",-629407757));
var estatura_36132 = cljs.core.get.call(null,map__36125_36128__$1,new cljs.core.Keyword(null,"estatura","estatura",-685084760));
var csv_data_36133 = testdouble.cljs.csv.write_csv.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Nome",nome_36129], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Data de Nascimento",react_med.screens.patient_info.core.yyyy_mm_dd__GT_dd_mm_yyyy.call(null,nascimento_36130)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Sexo",sexo_36131], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Estatura",cljs.core.str.cljs$core$IFn$_invoke$arity$1(estatura_36132).replace(".",",")], null)], null),new cljs.core.Keyword(null,"quote?","quote?",-1114029317),true);
console.log("arquivo!",(new File(["x,y,z"],"Avaliacao.csv",({"type": cljs.core.type}))));

console.log("csv\n",csv_data_36133);

react_med.screens.patient_info.core.share.call(null,csv_data_36133,"teste.csv","text/csv");
...
react_med.screens.patient_info.core.change_patient_name = (function react_med$screens$patient_info$core$change_patient_name(app_state,p__36134){
var vec__36135 = p__36134;
var event = cljs.core.nth.call(null,vec__36135,(0),null);
var new_name = cljs.core.nth.call(null,vec__36135,(1),null);
...
return result__14245__auto__;
}catch (e36138){var e = e36138;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_patient_name = (function react_med$screens$patient_info$core$change_patient_name(app_state,p__36139){
var vec__36140 = p__36139;
var event = cljs.core.nth.call(null,vec__36140,(0),null);
var new_name = cljs.core.nth.call(null,vec__36140,(1),null);
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.screens.patient_info.core.change_birth_date = (function react_med$screens$patient_info$core$change_birth_date(app_state,p__36143){
var vec__36144 = p__36143;
var event = cljs.core.nth.call(null,vec__36144,(0),null);
var new_birth_date = cljs.core.nth.call(null,vec__36144,(1),null);
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
return result__14245__auto__;
}catch (e36147){var e = e36147;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_birth_date = (function react_med$screens$patient_info$core$change_birth_date(app_state,p__36148){
var vec__36149 = p__36148;
var event = cljs.core.nth.call(null,vec__36149,(0),null);
var new_birth_date = cljs.core.nth.call(null,vec__36149,(1),null);
...
var result__14245__auto__ = p1__36152_SHARP_;
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),new cljs.core.Symbol(null,"p1__36152#","p1__36152#",1791822453,null),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(4)], null));

return result__14245__auto__;
})(),"Feminino");
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__36152#","p1__36152#",1791822453,null),"Feminino"),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(3)], null));

return result__14245__auto__;
})())?"Masculino":"Feminino");
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__36152#","p1__36152#",1791822453,null),"Feminino"),"Masculino","Feminino"),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(2)], null));

return result__14245__auto__;
});})(opts__14244__auto____$1,opts__14244__auto__,_PLUS_debux_dbg_opts_PLUS_))
;
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__36152#","p1__36152#",1791822453,null)], null),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__36152#","p1__36152#",1791822453,null),"Feminino"),"Masculino","Feminino")),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(1)], null));

return result__14245__auto__;
})());
debux.common.util.send_trace_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"result","result",1415092211),result__14245__auto__,new cljs.core.Keyword(null,"form","form",-1624062471),cljs.core.list(new cljs.core.Symbol(null,"update-in","update-in",-1445516941,null),new cljs.core.Symbol(null,"app-state","app-state",130568249,null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"domain","domain",1847214937),new cljs.core.Keyword(null,"patients","patients",134252075),(0),new cljs.core.Keyword(null,"sexo","sexo",-629407757)], null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__36152#","p1__36152#",1791822453,null)], null),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"p1__36152#","p1__36152#",1791822453,null),"Feminino"),"Masculino","Feminino"))),new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),(0)], null));

return result__14245__auto__;
}catch (e36153){var e = e36153;
throw e;
}});
} else {
react_med.screens.patient_info.core.toggle_sexo = (function react_med$screens$patient_info$core$toggle_sexo(app_state){
return cljs.core.update_in.call(null,app_state,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"domain","domain",1847214937),new cljs.core.Keyword(null,"patients","patients",134252075),(0),new cljs.core.Keyword(null,"sexo","sexo",-629407757)], null),(function (p1__36152_SHARP_){
if(cljs.core._EQ_.call(null,p1__36152_SHARP_,"Feminino")){
return "Masculino";
} else {
return "Feminino";
}
...
if(day8.re_frame.tracing.is_trace_enabled_QMARK_.call(null)){
react_med.screens.patient_info.core.change_height = (function react_med$screens$patient_info$core$change_height(app_state,p__36154){
var vec__36155 = p__36154;
var event = cljs.core.nth.call(null,vec__36155,(0),null);
var new_height = cljs.core.nth.call(null,vec__36155,(1),null);
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
return result__14245__auto__;
}catch (e36158){var e = e36158;
throw e;
}});
} else {
react_med.screens.patient_info.core.change_height = (function react_med$screens$patient_info$core$change_height(app_state,p__36159){
var vec__36160 = p__36159;
var event = cljs.core.nth.call(null,vec__36160,(0),null);
var new_height = cljs.core.nth.call(null,vec__36160,(1),null);
...
var vec__36163 = cljs.core.re_find.call(null,/(\d{1,2})\D(\d{1,2})\D(\d{4})/,text);
var _ = cljs.core.nth.call(null,vec__36163,(0),null);
var d = cljs.core.nth.call(null,vec__36163,(1),null);
var m = cljs.core.nth.call(null,vec__36163,(2),null);
var y = cljs.core.nth.call(null,vec__36163,(3),null);
...
var map__36169 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.patient-info.core","selected-patient","react-med.screens.patient-info.core/selected-patient",-1719364628)], null));
...
var map__36171 = react_med.util._LT_sub.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("react-med.screens.patient-info.core","selected-patient","react-med.screens.patient-info.core/selected-patient",-1719364628)], null));
...
var nome = cljs.core.get.call(null,map__36171__$1,new cljs.core.Keyword(null,"nome","nome",1100401122));
var nascimento = cljs.core.get.call(null,map__36171__$1,new cljs.core.Keyword(null,"nascimento","nascimento",646565528));
var idade = cljs.core.get.call(null,map__36171__$1,new cljs.core.Keyword(null,"idade","idade",297389078));
var sexo = cljs.core.get.call(null,map__36171__$1,new cljs.core.Keyword(null,"sexo","sexo",-629407757));
var estatura = cljs.core.get.call(null,map__36171__$1,new cljs.core.Keyword(null,"estatura","estatura",-685084760));
...
react_med.screens.patient_info.core.patient_detail = (function react_med$screens$patient_info$core$patient_detail(p__36173,content_view){
...
var actions = cljs.core.get.call(null,map__36174__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
