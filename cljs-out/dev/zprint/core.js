...
if((function (){var and__4120__auto__ = cljs.core.coll_QMARK_.call(null,z);
...
var or__4131__auto__ = zprint.core.rewrite_clj_zipper_QMARK_.call(null,z);
...
var vec__26531 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper.call(null,options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__26534 = zprint.zutil.find_root_and_path_nw.call(null,coll);
var root = cljs.core.nth.call(null,vec__26534,(0),null);
var path = cljs.core.nth.call(null,vec__26534,(1),null);
...
var input = cljs.core.nth.call(null,vec__26531,(0),null);
var options__$1 = cljs.core.nth.call(null,vec__26531,(1),null);
...
var fzprint_fn = cljs.core.partial.call(null,zprint.zprint.fzprint,options__$2,(cljs.core.truth_((function (){var and__4120__auto__ = new cljs.core.Keyword(null,"file?","file?",1755223728).cljs$core$IFn$_invoke$arity$1(options__$2);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__26537){
var vec__26538 = p__26537;
var width_or_options = cljs.core.nth.call(null,vec__26538,(0),null);
var options = cljs.core.nth.call(null,vec__26538,(1),null);
...
var auto_width = (cljs.core.truth_((function (){var and__4120__auto__ = cljs.core.not.call(null,width);
if(and__4120__auto__){
...
var vec__26544 = zprint.config.perform_remove.call(null,null,null,zprint.config.get_options.call(null),rest_options);
var internal_map = cljs.core.nth.call(null,vec__26544,(0),null);
var rest_options__$1 = cljs.core.nth.call(null,vec__26544,(1),null);
var _ = cljs.core.nth.call(null,vec__26544,(2),null);
var vec__26547 = zprint.config.apply_style.call(null,null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.call(null,vec__26547,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__26547,(1),null);
var style_errors = cljs.core.nth.call(null,vec__26547,(2),null);
...
var G__26550 = special_option;
var G__26550__$1 = (((G__26550 instanceof cljs.core.Keyword))?G__26550.fqn:null);
switch (G__26550__$1) {
case "explain":
return zprint.core.fzprint_style.call(null,zprint.config.get_explained_options.call(null),zprint.config.get_default_options.call(null));

break;
case "explain-justified":
return zprint.core.fzprint_style.call(null,zprint.config.get_explained_options.call(null),zprint.config.merge_deep.call(null,zprint.config.get_default_options.call(null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"justify?","justify?",294994148),true], null)], null)));

break;
case "support":
return zprint.core.fzprint_style.call(null,zprint.config.get_explained_all_options.call(null),zprint.config.get_default_options.call(null));
...
return zprint.core.fzprint_style.call(null,coll,(function (){var temp__5733__auto__ = new cljs.core.Keyword(null,"fn-name","fn-name",-766594004).cljs$core$IFn$_invoke$arity$1(actual_options);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__26552){
var vec__26553 = p__26552;
var start = cljs.core.nth.call(null,vec__26553,(0),null);
var end = cljs.core.nth.call(null,vec__26553,(1),null);
...
var len__4730__auto___26565 = arguments.length;
var i__4731__auto___26566 = (0);
while(true){
if((i__4731__auto___26566 < len__4730__auto___26565)){
args__4736__auto__.push((arguments[i__4731__auto___26566]));

var G__26567 = (i__4731__auto___26566 + (1));
i__4731__auto___26566 = G__26567;
continue;
} else {
}
break;
...
var vec__26559 = zprint.core.process_rest_options.call(null,internal_options,rest);
var special_option = cljs.core.nth.call(null,vec__26559,(0),null);
var rest_options = cljs.core.nth.call(null,vec__26559,(1),null);
...
var vec__26562 = zprint.core.zprint_STAR_.call(null,coll,special_option,actual_options);
var cvec = cljs.core.nth.call(null,vec__26562,(0),null);
var options = cljs.core.nth.call(null,vec__26562,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq26556){
var G__26557 = cljs.core.first.call(null,seq26556);
var seq26556__$1 = cljs.core.next.call(null,seq26556);
var G__26558 = cljs.core.first.call(null,seq26556__$1);
var seq26556__$2 = cljs.core.next.call(null,seq26556__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26557,G__26558,seq26556__$2);
});
...
var args__4736__auto__ = [];
var len__4730__auto___26572 = arguments.length;
var i__4731__auto___26573 = (0);
while(true){
if((i__4731__auto___26573 < len__4730__auto___26572)){
args__4736__auto__.push((arguments[i__4731__auto___26573]));

var G__26574 = (i__4731__auto___26573 + (1));
i__4731__auto___26573 = G__26574;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq26570){
var G__26571 = cljs.core.first.call(null,seq26570);
var seq26570__$1 = cljs.core.next.call(null,seq26570);
var self__4717__auto__ = this;
...
var args__4736__auto__ = [];
var len__4730__auto___26577 = arguments.length;
var i__4731__auto___26578 = (0);
while(true){
if((i__4731__auto___26578 < len__4730__auto___26577)){
args__4736__auto__.push((arguments[i__4731__auto___26578]));

var G__26579 = (i__4731__auto___26578 + (1));
i__4731__auto___26578 = G__26579;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq26575){
var G__26576 = cljs.core.first.call(null,seq26575);
var seq26575__$1 = cljs.core.next.call(null,seq26575);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26576,seq26575__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___26582 = arguments.length;
var i__4731__auto___26583 = (0);
while(true){
if((i__4731__auto___26583 < len__4730__auto___26582)){
args__4736__auto__.push((arguments[i__4731__auto___26583]));

var G__26584 = (i__4731__auto___26583 + (1));
i__4731__auto___26583 = G__26584;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq26580){
var G__26581 = cljs.core.first.call(null,seq26580);
var seq26580__$1 = cljs.core.next.call(null,seq26580);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26581,seq26580__$1);
});
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq26585){
var G__26586 = cljs.core.first.call(null,seq26585);
var seq26585__$1 = cljs.core.next.call(null,seq26585);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26586,seq26585__$1);
});
...
var comment_split = clojure.string.split.call(null,s,/^;!zprint /);
var temp__5735__auto__ = cljs.core.second.call(null,comment_split);
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__26591,form){
var vec__26592 = p__26591;
var next_options = cljs.core.nth.call(null,vec__26592,(0),null);
var _ = cljs.core.nth.call(null,vec__26592,(1),null);
var indent = cljs.core.nth.call(null,vec__26592,(2),null);
var zprint_num = cljs.core.nth.call(null,vec__26592,(3),null);
...
var vec__26595 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.call(null,vec__26595,(0),null);
var error_str = cljs.core.nth.call(null,vec__26595,(1),null);
...
var drop_QMARK_ = (!(cljs.core.not.call(null,(function (){var and__4120__auto__ = space_count;
if(cljs.core.truth_(and__4120__auto__)){
var and__4120__auto____$1 = (!(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"skip","skip",602715391),new cljs.core.Keyword(null,"format","format",-1306924766).cljs$core$IFn$_invoke$arity$1(next_options__$1))));
if(and__4120__auto____$1){
...
var output_str = ((((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"off","off",606440789),new cljs.core.Keyword(null,"format","format",-1306924766).cljs$core$IFn$_invoke$arity$1(decision_options))) || (((cljs.core.not.call(null,(function (){var or__4131__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [((local_QMARK_)?zprint.config.merge_deep.call(null,next_options__$1,new_options):(cljs.core.truth_((function (){var or__4131__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return whitespace_form_QMARK_;
...
var filestring__$1 = ((cljs.core._EQ_.call(null,cljs.core.last.call(null,file_str),"\n"))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(filestring),"\n"].join(''):filestring);
var forms = zprint.zutil.edn_STAR_.call(null,rewrite_clj.parser.parse_string_all.call(null,filestring__$1));
return zprint.core.process_multiple_forms.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"process-bang-zprint?","process-bang-zprint?",-1250782024),true,new cljs.core.Keyword(null,"color?","color?",-1891974356),false], null),zprint.core.czprint_str_internal,zprint_specifier,forms);
...
var temp__5735__auto__ = cljs.core.get.call(null,fn_spec,key);
if(cljs.core.truth_(temp__5735__auto__)){
