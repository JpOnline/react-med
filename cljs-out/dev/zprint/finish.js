...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__25624_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__25624_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__25624_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__25625){
var vec__25626 = p__25625;
var low = cljs.core.nth.call(null,vec__25626,(0),null);
var high = cljs.core.nth.call(null,vec__25626,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__25629,s,color,element,idx){
var map__25630 = p__25629;
var map__25630__$1 = (((((!((map__25630 == null))))?(((((map__25630.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25630.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25630):map__25630);
var style_map = cljs.core.get.call(null,map__25630__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__25630__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__25630__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__25632){
var vec__25633 = p__25632;
var s = cljs.core.nth.call(null,vec__25633,(0),null);
var style = cljs.core.nth.call(null,vec__25633,(1),null);
var start = cljs.core.nth.call(null,vec__25633,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__25636){
var vec__25637 = p__25636;
var s = cljs.core.nth.call(null,vec__25637,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__25637,(1),null);
var element = cljs.core.nth.call(null,vec__25637,(2),null);
...
var G__25640 = cljs.core.next.call(null,ssv);
var G__25641 = (this_ssv == null);
var G__25642 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__25643 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__25640;
doing_nil_QMARK_ = G__25641;
last_elide = G__25642;
out = G__25643;
continue;
}
...
var vec__25647 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__25647,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__25647,(1),null);
var element_type = cljs.core.nth.call(null,vec__25647,(2),null);
...
var G__25650 = cljs.core.next.call(null,remaining_cvec);
var G__25651 = new_idx;
var G__25652 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__25650;
idx = G__25651;
out = G__25652;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__25663,cursor_vec){
var vec__25664 = p__25663;
var focus_start = cljs.core.nth.call(null,vec__25664,(0),null);
var focus_end = cljs.core.nth.call(null,vec__25664,(1),null);
var focus_vec = vec__25664;
...
var vec__25667 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__25667,(0),null);
var back = cljs.core.nth.call(null,vec__25667,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__25670){
var vec__25671 = p__25670;
var s = cljs.core.nth.call(null,vec__25671,(0),null);
var color = cljs.core.nth.call(null,vec__25671,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__25677,existing_count){
var vec__25678 = p__25677;
var s = cljs.core.nth.call(null,vec__25678,(0),null);
var cursor = cljs.core.nth.call(null,vec__25678,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__25678,s,cursor){
return (function (p1__25674_SHARP_){
return (!(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__25674_SHARP_))));
});})(s__$1,len,cursor__$1,vec__25678,s,cursor))
...
var vec__25685 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__25685,(0),null);
var where = cljs.core.nth.call(null,vec__25685,(1),null);
var cvec_element = vec__25685;
if((cvec_element == null)){
var G__25688 = cljs.core.next.call(null,cvec_nl);
var G__25689 = (idx + (1));
var G__25690 = start;
var G__25691 = out;
cvec_nl = G__25688;
...
var G__25692 = cljs.core.next.call(null,cvec_nl);
var G__25693 = (idx + (1));
var G__25694 = idx;
var G__25695 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__25692;
idx = G__25693;
start = G__25694;
out = G__25695;
...
var G__25696 = cljs.core.next.call(null,cvec_nl);
var G__25697 = (idx + (1));
var G__25698 = (idx + (1));
var G__25699 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__25696;
idx = G__25697;
start = G__25698;
out = G__25699;
...
var G__25700 = cljs.core.next.call(null,cvec_nl);
var G__25701 = (idx + (1));
var G__25702 = idx;
var G__25703 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__25700;
idx = G__25701;
start = G__25702;
out = G__25703;
...
var G__25704 = cljs.core.next.call(null,cvec_nl);
var G__25705 = (idx + (1));
var G__25706 = start;
var G__25707 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__25704;
idx = G__25705;
start = G__25706;
out = G__25707;
...
return cljs.core.reduce.call(null,(function (p1__25709_SHARP_,p2__25708_SHARP_){
if(zprint.finish.within_QMARK_.call(null,idx,p2__25708_SHARP_)){
return cljs.core.reduced.call(null,p1__25709_SHARP_);
} else {
return (p1__25709_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__25710,p__25711){
var vec__25712 = p__25710;
var focus_begin = cljs.core.nth.call(null,vec__25712,(0),null);
var focus_end = cljs.core.nth.call(null,vec__25712,(1),null);
var vec__25715 = p__25711;
var before = cljs.core.nth.call(null,vec__25715,(0),null);
var after = cljs.core.nth.call(null,vec__25715,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__25719,cvec,focus_vec){
var map__25720 = p__25719;
var map__25720__$1 = (((((!((map__25720 == null))))?(((((map__25720.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25720.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25720):map__25720);
var options = map__25720__$1;
var map__25721 = cljs.core.get.call(null,map__25720__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.call(null,map__25721__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__25721__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__25721__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__25720,map__25720__$1,options,map__25721,map__25721__$1,focus,lines,paths){
return (function (p1__25718_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__25718_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__25720,map__25720__$1,options,map__25721,map__25721__$1,focus,lines,paths))
,path_vecs);
