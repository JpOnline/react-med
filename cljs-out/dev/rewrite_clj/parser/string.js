...
if((c === "\n")){
var G__23906 = escape_QMARK_;
var G__23907 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__23906;
lines = G__23907;
continue;
} else {
buf.append(c);

var G__23908 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__23909 = lines;
escape_QMARK_ = G__23908;
lines = G__23909;
continue;
