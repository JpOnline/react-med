...
var len__4730__auto___25857 = arguments.length;
var i__4731__auto___25858 = (0);
while(true){
if((i__4731__auto___25858 < len__4730__auto___25857)){
args__4736__auto__.push((arguments[i__4731__auto___25858]));

var G__25859 = (i__4731__auto___25858 + (1));
i__4731__auto___25858 = G__25859;
continue;
} else {
}
break;
...
return clojure.zip.edit.call(null,zloc,rewrite_clj.zip.editz.edit_node,(function (p1__25853_SHARP_){
return cljs.core.apply.call(null,f,p1__25853_SHARP_,args);
}));
});
...
/** @this {Function} */
rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq25854){
var G__25855 = cljs.core.first.call(null,seq25854);
var seq25854__$1 = cljs.core.next.call(null,seq25854);
var G__25856 = cljs.core.first.call(null,seq25854__$1);
var seq25854__$2 = cljs.core.next.call(null,seq25854__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25855,G__25856,seq25854__$2);
});
...
var G__25862 = rewrite_clj.zip.base.tag.call(null,zloc);
var G__25862__$1 = (((G__25862 instanceof cljs.core.Keyword))?G__25862.fqn:null);
switch (G__25862__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token.call(null,zloc,((function (G__25862,G__25862__$1){
return (function (p1__25860_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__25860_SHARP_)].join('');
});})(G__25862,G__25862__$1))
);

break;
case "multi-line":
return rewrite_clj.zip.editz.edit_multi_line.call(null,zloc,((function (G__25862,G__25862__$1){
return (function (lines){
if(cljs.core.empty_QMARK_.call(null,lines)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null);
} else {
return cljs.core.update_in.call(null,lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),((function (G__25862,G__25862__$1){
return (function (p1__25861_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__25861_SHARP_)].join('');
});})(G__25862,G__25862__$1))
);
}
});})(G__25862,G__25862__$1))
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25862__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__25865 = rewrite_clj.zip.base.tag.call(null,zloc);
var G__25865__$1 = (((G__25865 instanceof cljs.core.Keyword))?G__25865.fqn:null);
switch (G__25865__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token.call(null,zloc,((function (G__25865,G__25865__$1){
return (function (p1__25864_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__25864_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
});})(G__25865,G__25865__$1))
);

break;
case "multi-line":
return rewrite_clj.zip.editz.edit_multi_line.call(null,zloc,((function (G__25865,G__25865__$1){
return (function (lines){
if(cljs.core.empty_QMARK_.call(null,lines)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null);
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25865__$1)].join('')));
