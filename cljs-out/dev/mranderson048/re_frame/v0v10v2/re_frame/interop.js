...
return [(function (){var pred__24437 = cljs.core.instance_QMARK_;
var expr__24438 = reactive_val;
if(cljs.core.truth_(pred__24437.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.RAtom,expr__24438))){
return "ra";
} else {
if(cljs.core.truth_(pred__24437.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.RCursor,expr__24438))){
return "rc";
} else {
if(cljs.core.truth_(pred__24437.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.Reaction,expr__24438))){
return "rx";
} else {
if(cljs.core.truth_(pred__24437.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.Track,expr__24438))){
return "tr";
} else {
return "other";
}
