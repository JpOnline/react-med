...
var vec__24491_24494 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_24495 = cljs.core.nth.call(null,vec__24491_24494,(0),null);
var only_after_24496 = cljs.core.nth.call(null,vec__24491_24494,(1),null);
var db_changed_QMARK__24497 = (((!((only_before_24495 == null)))) || ((!((only_after_24496 == null)))));
if(db_changed_QMARK__24497){
...
mranderson048.re_frame.v0v10v2.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_24495);

mranderson048.re_frame.v0v10v2.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_24496);
...
var map__24498 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__24498__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__24498__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__24500 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__24500__$1;
var event = cljs.core.get.call(null,map__24500__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
return mranderson048.re_frame.v0v10v2.re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__4737__auto__);
});
...
/** @this {Function} */
mranderson048.re_frame.v0v10v2.re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq24502){
...
var event = mranderson048.re_frame.v0v10v2.re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__4131__auto__ = mranderson048.re_frame.v0v10v2.re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__4736__auto__ = [];
var len__4730__auto___24511 = arguments.length;
var i__4731__auto___24512 = (0);
while(true){
if((i__4731__auto___24512 < len__4730__auto___24511)){
args__4736__auto__.push((arguments[i__4731__auto___24512]));

var G__24513 = (i__4731__auto___24512 + (1));
i__4731__auto___24512 = G__24513;
continue;
} else {
}
break;
...
return mranderson048.re_frame.v0v10v2.re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4737__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__24506_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__24507_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__24507_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__4120__auto__ = cljs.core.contains_QMARK_.call(null,mranderson048.re_frame.v0v10v2.re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
/** @this {Function} */
mranderson048.re_frame.v0v10v2.re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq24508){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24509,G__24510,seq24508__$2);
});
