...
return ((cljs.core.map_QMARK_.call(null,m)) && (cljs.core._EQ_.call(null,mranderson048.re_frame.v0v10v2.re_frame.interceptor.mandatory_interceptor_keys,cljs.core.set.call(null,cljs.core.keys.call(null,m)))));
});
/**
...
mranderson048.re_frame.v0v10v2.re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__24445){
...
var m = map__24446__$1;
var id = cljs.core.get.call(null,map__24446__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var before = cljs.core.get.call(null,map__24446__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.call(null,map__24446__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(mranderson048.re_frame.v0v10v2.re_frame.interop.debug_enabled_QMARK_){
var temp__5733__auto___24451 = cljs.core.seq.call(null,clojure.set.difference.call(null,cljs.core.set.call(null,cljs.core.keys.call(null,m)),mranderson048.re_frame.v0v10v2.re_frame.interceptor.mandatory_interceptor_keys));
if(temp__5733__auto___24451){
var unknown_keys_24452 = temp__5733__auto___24451;
mranderson048.re_frame.v0v10v2.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"error","error",-978969032),"re-frame: ->interceptor ",m," has unknown keys:",unknown_keys_24452);
} else {
}
} else {
}
...
/** @this {Function} */
mranderson048.re_frame.v0v10v2.re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq24444){
...
var args__4736__auto__ = [];
var len__4730__auto___24463 = arguments.length;
var i__4731__auto___24464 = (0);
while(true){
if((i__4731__auto___24464 < len__4730__auto___24463)){
args__4736__auto__.push((arguments[i__4731__auto___24464]));

var G__24465 = (i__4731__auto___24464 + (1));
i__4731__auto___24464 = G__24465;
continue;
} else {
}
break;
...
/** @this {Function} */
mranderson048.re_frame.v0v10v2.re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq24459){
...
var G__24462 = cljs.core.first.call(null,seq24459__$2);
var seq24459__$3 = cljs.core.next.call(null,seq24459__$2);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24460,G__24461,G__24462,seq24459__$3);
});
...
return cljs.core.update.call(null,context,new cljs.core.Keyword(null,"queue","queue",1455835879),cljs.core.fnil.call(null,cljs.core.into,mranderson048.re_frame.v0v10v2.re_frame.interop.empty_queue),interceptors);
});
/**
...
return mranderson048.re_frame.v0v10v2.re_frame.interceptor.enqueue.call(null,mranderson048.re_frame.v0v10v2.re_frame.interceptor.assoc_coeffect.call(null,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"event","event",301435442),event),interceptors);
});

mranderson048.re_frame.v0v10v2.re_frame.interceptor.context.cljs$core$IFn$_invoke$arity$3 = (function (event,interceptors,db){
return mranderson048.re_frame.v0v10v2.re_frame.interceptor.assoc_coeffect.call(null,mranderson048.re_frame.v0v10v2.re_frame.interceptor.context.call(null,event,interceptors),new cljs.core.Keyword(null,"db","db",993250759),db);
});
...
return mranderson048.re_frame.v0v10v2.re_frame.interceptor.enqueue.call(null,cljs.core.dissoc.call(null,context,new cljs.core.Keyword(null,"queue","queue",1455835879)),new cljs.core.Keyword(null,"stack","stack",-793405930).cljs$core$IFn$_invoke$arity$1(context));
});
/**
...
return mranderson048.re_frame.v0v10v2.re_frame.interceptor.invoke_interceptors.call(null,mranderson048.re_frame.v0v10v2.re_frame.interceptor.change_direction.call(null,mranderson048.re_frame.v0v10v2.re_frame.interceptor.invoke_interceptors.call(null,mranderson048.re_frame.v0v10v2.re_frame.interceptor.context.call(null,event_v,interceptors),new cljs.core.Keyword(null,"before","before",-1633692388))),new cljs.core.Keyword(null,"after","after",594996914));
});
