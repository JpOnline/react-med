...
mranderson048.reagent.v0v7v0.reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4374__auto__,writer__4375__auto__,opt__4376__auto__){
return cljs.core._write.call(null,writer__4375__auto__,"mranderson048.reagent.v0v7v0.reagent.impl.template/NativeWrapper");
});
...
var temp__5737__auto__ = mranderson048.reagent.v0v7v0.reagent.impl.template.cache_get.call(null,mranderson048.reagent.v0v7v0.reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var G__24283 = o;
(G__24283[mranderson048.reagent.v0v7v0.reagent.impl.template.cached_prop_name.call(null,k)] = mranderson048.reagent.v0v7v0.reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__24284__delegate = function (args){
...
while (G__24285__i < G__24285__a.length) {G__24285__a[G__24285__i] = arguments[G__24285__i + 0]; ++G__24285__i;}
  args = new cljs.core.IndexedSeq(G__24285__a,0,null);
} 
return G__24284__delegate.call(this,args);};
G__24284.cljs$lang$maxFixedArity = 0;
G__24284.cljs$lang$applyTo = (function (arglist__24286){
var args = cljs.core.seq(arglist__24286);
return G__24284__delegate(args);
});
...
var G__24289 = jsprops;
(G__24289["defaultValue"] = value);

(G__24289["onChange"] = ((function (G__24289,v,value,on_change){
return (function (p1__24288_SHARP_){
return mranderson048.reagent.v0v7v0.reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24288_SHARP_);
});})(G__24289,v,value,on_change))
);
...
var vec__24292 = cljs.core.next.call(null,cljs.core.re_matches.call(null,mranderson048.reagent.v0v7v0.reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24292,(0),null);
var id = cljs.core.nth.call(null,vec__24292,(1),null);
var class$ = cljs.core.nth.call(null,vec__24292,(2),null);
var class$__$1 = (((class$ == null))?null:clojure.string.replace.call(null,class$,/\./," "));
if(cljs.core.truth_(tag)){
} else {
throw (new Error(["Assert failed: ",["Invalid tag: '",cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccup_tag),"'",mranderson048.reagent.v0v7v0.reagent.impl.component.comp_name.call(null)].join(''),"\n","tag"].join('')));
}
...
var temp__5737__auto__ = mranderson048.reagent.v0v7v0.reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
if((temp__5737__auto__ == null)){
...
var jsprops = ({"argv": v});
var temp__5739__auto___24296 = mranderson048.reagent.v0v7v0.reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___24296 == null)){
} else {
var key_24297 = temp__5739__auto___24296;
(jsprops["key"] = key_24297);
}
...
var G__24298 = mranderson048.reagent.v0v7v0.reagent.impl.template.__GT_NativeWrapper.call(null);
(G__24298["name"] = c);
...
var temp__5737__auto__ = mranderson048.reagent.v0v7v0.reagent.impl.template.cache_get.call(null,mranderson048.reagent.v0v7v0.reagent.impl.template.tag_name_cache,x);
if((temp__5737__auto__ == null)){
...
return mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4737__auto__);
});

mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic = (function (v,msg){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.call(null,cljs.core.str,msg)),": ",mranderson048.reagent.v0v7v0.reagent.impl.template.str_coll.call(null,v),"\n",mranderson048.reagent.v0v7v0.reagent.impl.component.comp_name.call(null)].join('');
});

mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.cljs$lang$maxFixedArity = (1);

/** @this {Function} */
mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24302){
var G__24303 = cljs.core.first.call(null,seq24302);
var seq24302__$1 = cljs.core.next.call(null,seq24302);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24303,seq24302__$1);
});
...
throw (new Error(["Assert failed: ",mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.call(null,v,"Hiccup form should not be empty"),"\n","(pos? (count v))"].join('')));
}
...
throw (new Error(["Assert failed: ",mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.call(null,v,"Invalid Hiccup form"),"\n","(valid-tag? tag)"].join('')));
}
...
throw (new Error(["Assert failed: ",mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.call(null,v,"Invalid Hiccup tag"),"\n","(= \">\" n)"].join('')));
}

if(((typeof comp === 'string') || (cljs.core.fn_QMARK_.call(null,comp)))){
} else {
throw (new Error(["Assert failed: ",mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.call(null,v,"Expected React component in"),"\n","(or (string? comp) (fn? comp))"].join('')));
}
...
break;
default:
var G__24309 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24309;
continue;
...
var n__4607__auto___24311 = a.length;
var i_24312 = (0);
while(true){
if((i_24312 < n__4607__auto___24311)){
(a[i_24312] = mranderson048.reagent.v0v7v0.reagent.impl.template.as_element.call(null,(a[i_24312])));

var G__24313 = (i_24312 + (1));
i_24312 = G__24313;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___24314 = a.length;
var i_24315 = (0);
while(true){
if((i_24315 < n__4607__auto___24314)){
var val_24316 = (a[i_24315]);
if(((cljs.core.vector_QMARK_.call(null,val_24316)) && ((mranderson048.reagent.v0v7v0.reagent.impl.template.key_from_vec.call(null,val_24316) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_24315] = mranderson048.reagent.v0v7v0.reagent.impl.template.as_element.call(null,val_24316));

var G__24317 = (i_24315 + (1));
i_24315 = G__24317;
continue;
} else {
}
...
var ctx = ({});
var vec__24318 = mranderson048.reagent.v0v7v0.reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return mranderson048.reagent.v0v7v0.reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24318,(0),null);
var derefed = cljs.core.nth.call(null,vec__24318,(1),null);
if(cljs.core.truth_(derefed)){
if(cljs.core.truth_(mranderson048.reagent.v0v7v0.reagent.debug.has_console)){
(cljs.core.truth_(mranderson048.reagent.v0v7v0.reagent.debug.tracking)?mranderson048.reagent.v0v7v0.reagent.debug.track_console:console).warn(["Warning: ",mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.call(null,x,"Reactive deref not supported in lazy seq, ","it should be wrapped in doall")].join(''));
} else {
}
} else {
}
...
if(cljs.core.truth_(mranderson048.reagent.v0v7v0.reagent.debug.has_console)){
(cljs.core.truth_(mranderson048.reagent.v0v7v0.reagent.debug.tracking)?mranderson048.reagent.v0v7v0.reagent.debug.track_console:console).warn(["Warning: ",mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.call(null,x,"Every element in a seq should have a unique :key")].join(''));
} else {
}
} else {
}
...
var G__24321 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24321) {
case (0):
...
break;
default:
return (mranderson048.reagent.v0v7v0.reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24321){
