...
if((i < len)){
var k = (ks[i]);
var G__24252 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__24253 = (i + (1));
m = G__24252;
i = G__24253;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__24255 = c;
var G__24255__$1 = (((G__24255 == null))?null:G__24255.prototype);
if((G__24255__$1 == null)){
return null;
} else {
return (G__24255__$1["reagentRender"]);
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__24257 = c;
var G__24257__$1 = (((G__24257 == null))?null:G__24257.prototype);
if((G__24257__$1 == null)){
return null;
} else {
return (G__24257__$1["render"]);
}
})() == null)))));
});
...
while (G__24261__i < G__24261__a.length) {G__24261__a[G__24261__i] = arguments[G__24261__i + 0]; ++G__24261__i;}
  args = new cljs.core.IndexedSeq(G__24261__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__24264 = mranderson048.reagent.v0v7v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__24265 = c;
mranderson048.reagent.v0v7v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__24265;
...
(cljs.core.truth_(mranderson048.reagent.v0v7v0.reagent.debug.tracking)?mranderson048.reagent.v0v7v0.reagent.debug.track_console:console).error(["Error rendering component",cljs.core.str.cljs$core$IFn$_invoke$arity$1(mranderson048.reagent.v0v7v0.reagent.impl.component.comp_name.call(null))].join(''));
} else {
}
}
}
}finally {mranderson048.reagent.v0v7v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__24264;
}});
...
var G__24266 = key;
var G__24266__$1 = (((G__24266 instanceof cljs.core.Keyword))?G__24266.fqn:null);
switch (G__24266__$1) {
...
return ((function (G__24266,G__24266__$1){
...
var or__4131__auto__ = mranderson048.reagent.v0v7v0.reagent.impl.util._STAR_always_update_STAR_;
if(or__4131__auto__){
...
var c = this;
var G__24267_24269 = (c["cljsRatom"]);
if((G__24267_24269 == null)){
} else {
mranderson048.reagent.v0v7v0.reagent.ratom.dispose_BANG_.call(null,G__24267_24269);
}
...
var renders_24271 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_24272 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_24271));
if((cljs.core.count.call(null,renders_24271) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_24271))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_24272)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_24272)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__24270 = name;
switch (G__24270) {
case "":
...
var G__24274 = o;
(G__24274[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__24275 = (function (){var or__4131__auto__ = (function (){var G__24277 = c;
if((G__24277 == null)){
return null;
} else {
return (G__24277["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return (G__24275["_currentElement"]);
}
})();
var name = (function (){var G__24278 = elem;
var G__24278__$1 = (((G__24278 == null))?null:(G__24278["type"]));
if((G__24278__$1 == null)){
return null;
} else {
return (G__24278__$1["displayName"]);
}
})();
var path = (function (){var G__24279 = elem;
var G__24279__$1 = (((G__24279 == null))?null:(G__24279["_owner"]));
var G__24279__$2 = (((G__24279__$1 == null))?null:mranderson048.reagent.v0v7v0.reagent.impl.component.component_path.call(null,G__24279__$1));
if((G__24279__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24279__$2)," > "].join('');
}
})();
...
var n = (function (){var or__4131__auto__ = mranderson048.reagent.v0v7v0.reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__24280 = c;
var G__24280__$1 = (((G__24280 == null))?null:G__24280.constructor);
if((G__24280__$1 == null)){
return null;
} else {
return mranderson048.reagent.v0v7v0.reagent.impl.util.fun_name.call(null,G__24280__$1);
}
}
})();
...
var temp__5737__auto__ = mranderson048.reagent.v0v7v0.reagent.impl.component.cached_react_class.call(null,tag);
if((temp__5737__auto__ == null)){
