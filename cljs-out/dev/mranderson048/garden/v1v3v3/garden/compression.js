 ...
 */
mranderson048.garden.v1v3v3.garden.compression.token_fn = (function mranderson048$garden$v1v3v3$garden$compression$token_fn(p__27742){
var vec__27743 = p__27742;
var tag = cljs.core.nth.call(null,vec__27743,(0),null);
var re = cljs.core.nth.call(null,vec__27743,(1),null);
return ((function (vec__27743,tag,re){
return (function (s){
...
var len__4730__auto___27748 = arguments.length;
var i__4731__auto___27749 = (0);
while(true){
if((i__4731__auto___27749 < len__4730__auto___27748)){
args__4736__auto__.push((arguments[i__4731__auto___27749]));

var G__27750 = (i__4731__auto___27749 + (1));
i__4731__auto___27749 = G__27750;
continue;
} else {
}
break;
...
return p1__27746_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
mranderson048.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq27747){
...
var s2 = "";
while(true){
var temp__5733__auto__ = mranderson048.garden.v1v3v3.garden.compression.stylesheet_tokenizer.call(null,s1);
if(cljs.core.truth_(temp__5733__auto__)){
var map__27751 = temp__5733__auto__;
...
var tag = cljs.core.get.call(null,map__27751__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__27751__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__27751__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__27755 = cljs.core.subs.call(null,s1,size);
var G__27756 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__27754 = tag;
