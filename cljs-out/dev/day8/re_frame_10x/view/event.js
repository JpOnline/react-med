...
var open_QMARK__path = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.deref.call(null,mranderson048.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null))),code_execution_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(line)], null);
var max_column_width = cljs.core.deref.call(null,mranderson048.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","max-column-width","code/max-column-width",1552872919)], null)));
var trace_id = code_execution_id;
var open_QMARK_ = cljs.core.get_in.call(null,cljs.core.deref.call(null,mranderson048.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","code-open?","code/code-open?",1212488779)], null))),open_QMARK__path);
...
mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","set-code-visibility","code/set-code-visibility",-1072995010),open_QMARK__path,cljs.core.not.call(null,open_QMARK_)], null));
...
mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","repl-msg-state","code/repl-msg-state",-519328495),new cljs.core.Keyword(null,"start","start",-355208981)], null));
...
var re = cljs.core.re_pattern.call(null,["(\\s|\\(|\\[|\\{)","(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.string.regExpEscape.call(null,search_str)),")"].join(''));
...
return mranderson048.reagent.v0v7v0.reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),((function (scroll_pos){
return (function day8$re_frame_10x$view$event$event_expression_$_event_expression_component_will_update(this$){
var node = mranderson048.reagent.v0v7v0.reagent.core.dom_node.call(null,this$);
...
return (function (){
var highlighted_form = cljs.core.deref.call(null,mranderson048.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","highlighted-form","code/highlighted-form",-1258376614)], null)));
var form_str = cljs.core.deref.call(null,mranderson048.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","current-zprint-form","code/current-zprint-form",-1297458353)], null)));
var show_all_code_QMARK_ = cljs.core.deref.call(null,mranderson048.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","show-all-code?","code/show-all-code?",162236201)], null)));
var vec__28729 = day8.re_frame_10x.view.event.find_bounds.call(null,form_str,zprint.core.zprint_str.call(null,highlighted_form));
var start_index = cljs.core.nth.call(null,vec__28729,(0),null);
var end_index = cljs.core.nth.call(null,vec__28729,(1),null);
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.box,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"max-height","max-height",-612563804),(cljs.core.truth_(show_all_code_QMARK_)?null:[cljs.core.str.cljs$core$IFn$_invoke$arity$1(((10) * (17))),"px"].join('')),new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword(null,"border","border",1444987323),day8.re_frame_10x.view.event.code_border,new cljs.core.Keyword(null,"background-color","background-color",570434026),day8.re_frame_10x.common_styles.white_background_color], null),new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-double-click","on-double-click",1434856980),((function (highlighted_form,form_str,show_all_code_QMARK_,vec__28729,start_index,end_index,before,highlight,after,scroll_pos){
return (function (event){
mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","set-show-all-code?","code/set-show-all-code?",1632099789),cljs.core.not.call(null,show_all_code_QMARK_)], null));

return null;
});})(highlighted_form,form_str,show_all_code_QMARK_,vec__28729,start_index,end_index,before,highlight,after,scroll_pos))
...
var repl_msg_state = cljs.core.deref.call(null,mranderson048.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","repl-msg-state","code/repl-msg-state",-519328495)], null)));
...
return (function (){
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","repl-msg-state","code/repl-msg-state",-519328495),new cljs.core.Keyword(null,"end","end",-268185958)], null));
});})(repl_msg_state))
...
return mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","repl-msg-state","code/repl-msg-state",-519328495),new cljs.core.Keyword(null,"start","start",-355208981)], null));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.h_box,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.doall.call(null,(function (){var iter__4523__auto__ = (function day8$re_frame_10x$view$event$indent_block_$_iter__28732(s__28733){
return (new cljs.core.LazySeq(null,(function (){
var s__28733__$1 = s__28733;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__28733__$1);
if(temp__5735__auto__){
var s__28733__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__28733__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__28733__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__28735 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__28734 = (0);
while(true){
if((i__28734 < size__4522__auto__)){
var num = cljs.core._nth.call(null,c__4521__auto__,i__28734);
cljs.core.chunk_append.call(null,b__28735,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.box,new cljs.core.Keyword(null,"width","width",-384071477),"12px",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"background-color","background-color",570434026),day8.re_frame_10x.common_styles.standard_background_color,new cljs.core.Keyword(null,"border-top","border-top",-158897573),(cljs.core.truth_(first_QMARK_)?day8.re_frame_10x.view.event.code_border:null),new cljs.core.Keyword(null,"border-left","border-left",-1150760178),day8.re_frame_10x.view.event.code_border], null),new cljs.core.Keyword(null,"child","child",623967545),""], null));

var G__28736 = (i__28734 + (1));
i__28734 = G__28736;
continue;
} else {
return true;
...
return iter__4523__auto__.call(null,cljs.core.range.call(null,indent_level));
})())], null);
});
...
var code_open_QMARK_ = cljs.core.deref.call(null,mranderson048.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","code-open?","code/code-open?",1212488779)], null)));
var max_frags = (50);
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"size","size",1098693007),"1",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"overflow-y","overflow-y",-1436589285),"auto"], null),new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.doall.call(null,(function (){var iter__4523__auto__ = ((function (code_open_QMARK_,max_frags){
return (function day8$re_frame_10x$view$event$event_fragments_$_iter__28737(s__28738){
return (new cljs.core.LazySeq(null,((function (code_open_QMARK_,max_frags){
return (function (){
var s__28738__$1 = s__28738;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__28738__$1);
if(temp__5735__auto__){
var s__28738__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__28738__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__28738__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__28740 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__28739 = (0);
while(true){
if((i__28739 < size__4522__auto__)){
var frag = cljs.core._nth.call(null,c__4521__auto__,i__28739);
cljs.core.chunk_append.call(null,b__28740,(function (){var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(frag);
var first_QMARK_ = (id === (0));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"code-fragment",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),((first_QMARK_)?null:"-1px")], null),new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-enter","on-mouse-enter",-1664921661),((function (i__28739,id,first_QMARK_,frag,c__4521__auto__,size__4522__auto__,b__28740,s__28738__$2,temp__5735__auto__,code_open_QMARK_,max_frags){
return (function (event){
mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","hover-form","code/hover-form",1557522458),new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(frag)], null));

return null;
});})(i__28739,id,first_QMARK_,frag,c__4521__auto__,size__4522__auto__,b__28740,s__28738__$2,temp__5735__auto__,code_open_QMARK_,max_frags))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (i__28739,id,first_QMARK_,frag,c__4521__auto__,size__4522__auto__,b__28740,s__28738__$2,temp__5735__auto__,code_open_QMARK_,max_frags){
return (function (event){
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28740),day8$re_frame_10x$view$event$event_fragments_$_iter__28737.call(null,cljs.core.chunk_rest.call(null,s__28738__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28740),null);
}
} else {
var frag = cljs.core.first.call(null,s__28738__$2);
...
var first_QMARK_ = (id === (0));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"code-fragment",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),((first_QMARK_)?null:"-1px")], null),new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-enter","on-mouse-enter",-1664921661),((function (id,first_QMARK_,frag,s__28738__$2,temp__5735__auto__,code_open_QMARK_,max_frags){
return (function (event){
mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","hover-form","code/hover-form",1557522458),new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(frag)], null));

return null;
});})(id,first_QMARK_,frag,s__28738__$2,temp__5735__auto__,code_open_QMARK_,max_frags))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (id,first_QMARK_,frag,s__28738__$2,temp__5735__auto__,code_open_QMARK_,max_frags){
return (function (event){
mranderson048.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","exit-hover-form","code/exit-hover-form",-202062797),new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(frag)], null));
...
})(),day8$re_frame_10x$view$event$event_fragments_$_iter__28737.call(null,cljs.core.rest.call(null,s__28738__$2)));
}
} else {
return null;
}
...
;
return iter__4523__auto__.call(null,cljs.core.take.call(null,max_frags,fragments));
...
var code_traces = cljs.core.deref.call(null,mranderson048.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","current-code","code/current-code",17389180)], null)));
...
var epoch_id = cljs.core.deref.call(null,mranderson048.re_frame.v0v10v2.re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null)));
